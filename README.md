<p align="center">
  <a href="https://genoffice.ai/">
    <picture>
      ...
      <img src="docs/assets/readme/hero.webp" alt="Zanostack — the open-source AI Office suite: Docs, Sheets, Slides, PDF, Markdown and HTML with a built-in AI panel" width="100%">
    </picture>
  </a>
</p>

<h1 align="center">Zanostack</h1>
...
Zanostack is a free, open-source alternative to Microsoft Office for macOS,
...
<table>
<tr>
<td width="50%"><img src="docs/assets/readme/docs-report.webp" alt="Zanostack Docs rendering a two-column annual-report page with a full-width cover image, shaded KPI table, header and footer, at 80% zoom with the AI panel collapsed"></td>
<td width="50%"><img src="docs/assets/readme/docs-ai.webp" alt="Zanostack Docs: a company overview with a banner image; the AI tightened the Overview and inserted a new bulleted section, and the panel offers a one-click roll back"></td>
</tr>
<tr>
...
<table>
<tr>
<td width="50%"><img src="docs/assets/readme/sheets-ai.webp" alt="Zanostack Sheets: the AI added a Summary sheet with revenue by region and category using SUMIF formulas, plus a column chart, and reports 43 applied changes with an Undo button"></td>
<td width="50%"><img src="docs/assets/readme/sheets-qa.webp" alt="Zanostack Sheets: asked which region led Q2 revenue, the AI answers Europe with the category breakdown and cites the cells it used as links, next to the Orders sheet"></td>
</tr>
<tr>
...
<img src="docs/assets/readme/slides-generate.webp" alt="Time-lapse of Zanostack Slides generating the Aurora Home investor deck: the AI plans the storyline in the panel, slides appear on the canvas one after another, and the finished deck ends on the closing ask" width="100%">

<table>
<tr>
<td width="50%"><img src="docs/assets/readme/slides-cover.webp" alt="Zanostack Slides: the cover slide of an AI-generated Aurora Home investor deck on the canvas, with the original one-line prompt and the AI's summary of what it built in the panel"></td>
<td width="50%"><img src="docs/assets/readme/slides-ai.webp" alt="Zanostack Slides: the designed closing slide of the same 11-slide deck, with the thumbnail strip on the left and the AI panel summarizing the storyline"></td>
</tr>
<tr>
<td><b>One line in</b> — "Create a 10-slide investor pitch deck for Aurora Home…". Zanostack plans the storyline, researches the numbers, and drafts every slide onto the canvas as a real <code>.pptx</code>.</td>
...
<table>
<tr>
<td width="50%"><img src="docs/assets/readme/pdf-edit.webp" alt="Zanostack PDF: Edit text mode outlines every text block on the page for in-place editing while the AI panel answers a question about the report with page citations"></td>
<td width="50%"><img src="docs/assets/readme/pdf-convert.webp" alt="Zanostack Docs showing a Word document converted locally from the Helios quarterly review PDF, opened in a second tab beside the original PDF"></td>
</tr>
<tr>
...
<img src="docs/assets/readme/html-restyle-motion.webp" alt="Time-lapse of Zanostack HTML restyling the Lumen landing page: one Restyle request in the panel turns the dark Midnight Studio page into the warm Solar Daybreak version while every section and all copy stay in place" width="100%">

<table>
<tr>
<td width="50%"><img src="docs/assets/readme/html-ai.webp" alt="Zanostack HTML: a generated landing page for a solar desk lamp in the dark Midnight Studio direction, shown in the live preview with the AI panel summarizing the page it just built"></td>
...
<table>
<tr>
<td width="50%"><img src="docs/assets/readme/html-dashboard.webp" alt="Zanostack HTML: a generated personal dashboard UI for a freelance designer in a warm linen style, with a left rail, serif greeting and four metric cards"></td>
<td width="50%"><img src="docs/assets/readme/html-report.webp" alt="Zanostack HTML: a generated EV-market data report in a broadsheet style, with a serif masthead, a 17.3 million headline figure and a stat row"></td>
</tr>
<tr>
...
<table>
<tr>
<td width="50%"><img src="docs/assets/readme/markdown-ai.webp" alt="Zanostack Markdown: a selected paragraph shows an Ask AI popover with a typed instruction and suggestion chips such as Polish, Make more concise, Expand and Fix grammar, plus Send now and Add to queue buttons"></td>
<td width="50%"><img src="docs/assets/readme/markdown-render.webp" alt="Zanostack Markdown rendering a launch-notes document with a table, a Mermaid flowchart and a task list, with the AI panel's starter prompts on the left"></td>
</tr>
<tr>
...
and OpenCode Zen/Go, plus a custom slot for any OpenAI-compatible endpoint
(base URL + key), including local model servers. Search and media have their
own per-capability providers under **AI Media & Search**: Serper or Tavily for
web search, and OpenAI, Gemini, Doubao/Seedream, GLM, Grok, Qwen, MiniMax or
any OpenAI-compatible images endpoint for image generation and image/video
analysis.

**Genspark sign-in is optional** and stays hidden unless you turn it on; it is
never required to use the suite.
...
The deb installs with apt — it pulls in the dependencies and adds Zanostack
...
```bash
chmod +x Zanostack-<version>.AppImage
./Zanostack-<version>.AppImage
```
...
Zanostack is in active development and your feedback shapes it.
...
<details>
<summary><b>Is Zanostack free?</b></summary>

Yes. Zanostack is free and open-source under the Apache-2.0 license — no
trial, no paid tier for the apps themselves.

</details>

<details>
<summary><b>Can Zanostack open Microsoft Word, Excel and PowerPoint files?</b></summary>

Yes. Zanostack opens and saves native `.docx`, `.xlsx` and `.pptx` files.
...
<details>
<summary><b>Does Zanostack work offline?</b></summary>
...
<details>
<summary><b>Can Zanostack edit PDF files?</b></summary>
...
<details>
<summary><b>Can Zanostack convert PDF to Word, Excel or PowerPoint?</b></summary>
...
<details>
<summary><b>Can Zanostack convert HTML to Word?</b></summary>
...
<details>
<summary><b>Does Zanostack collect any data?</b></summary>
...
addresses. See [Zanostack Privacy](PRIVACY.md) for the complete event and
data disclosures.

</details>

**What is Zanostack CRM?**
Zanostack CRM is the sales pipeline app bundled with Zanostack. It manages
...
Zanostack would not be possible without these open-source projects:
