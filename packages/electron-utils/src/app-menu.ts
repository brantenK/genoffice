...
const LABELS: Record<string, Labels> = {
  ...
  it: {
    ...
    help: 'Aiuto',
    about: 'Informazioni su Zanostack',
...
export function aboutMenuItem(labels: AppMenuLabels): MenuItemConstructorOptions {
  return {
    ...
    click: async () => {
      ...
      if (response === 1) clipboard.writeText(`Zanostack ${version}`)
