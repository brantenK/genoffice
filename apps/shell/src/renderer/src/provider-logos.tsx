...
// 'genspark' is intentionally absent — the provider was removed from the
// fork; ProviderLogo falls back to the custom mark for unknown/legacy ids.
const LOGOS: Partial<Record<AiProviderId, ReactNode>> = {
  codex: (
    <svg
      viewBox="0 0 24 24"
      fill="none"
