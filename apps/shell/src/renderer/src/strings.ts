...
export const strings = {
  zh: {
    ...
    navRecent: '最近',
    navStarred: '收藏',
    navCloud: 'Zano Projects',
    cloudSubtitle: '在网页端用 Zano AI 创建的项目。编辑在浏览器中继续——点击任意项目即可打开。',
    ...
    cloudSortOldest: '最早',
    cloudRefresh: '刷新',
    cloudLoginHint: '登录 Zano 账号，查看你在网页端创建的项目。',
    cloudEmpty: '还没有网页端项目。',
    ...
    account: '账号',
    login: '登录',
    loginZano: '登录 Zano 账号',
    loggedIn: '已登录',
    loggedInZano: '已登录 Zano',
    ...
    loginCopyUrl: '复制登录链接',
    loginCopied: '已复制',
    loginNetworkError: '无法连接 Zano,请检查网络或代理设置',
    ...
    setAiZanoHint: '使用 Zano 账号登录，无需 API key。',
    setAiByokNote: '对话使用你自己的 key；网页搜索、生图等云工具仍需登录 Zano。',
    setAiSave: '保存',
    setAiSaved: '已保存',
    setAiTest: '测试连接',
    setAiTesting: '测试中…',
    setAiTestOk: '连接成功',
    setAiTestFail: '连接失败',
    setAiGskTools: 'Zano 云工具',
    setAiGskToolsDesc:
      '网页搜索、AI 生图、媒体分析经 Zano 云端并消耗积分；关闭后生图与媒体分析不可用，搜索改用免费来源。',
    setGithub: '开源项目',
    starOnGitHub: '去 GitHub 点 Star',
    starPromptTitle: '喜欢 Zanostack 吗？',
    starPromptTitleN: '你已经用 Zanostack 打开了 {n} 个文档',
    starPromptBody: 'Zanostack 是免费开源软件。到 GitHub 给我们一个 Star，是对团队最好的支持。',
    starPromptGo: '去点 Star',
    starPromptDone: '已经点过了',
    starPromptLater: '以后再说',
    onbStarHint: '如果你喜欢 Zanostack，欢迎到 GitHub 给我们一个 Star。',
    setEmail: '邮箱',
    setNotLoggedIn: '未登录',
    setViewUsage: '查看用量',
    setChange: '更改',
    ...
    onbTitle1: '欢迎使用 Zanostack',
    onbSubtitle1: '第一个开源的 AI 原生 Office 套件',
    onbBody1: '创建文档、制作表格、生成演示、审阅 PDF。AI 深度融入每个环节。',
    onbTitle2: '这只是一个开始',
    onbBody2: 'Zanostack 目前处于 alpha 阶段。欢迎加入 Zanostack 群聊，分享反馈，一起塑造它的未来。',
    onbCredits: '活跃贡献者可获得 **1,000+ Zano 积分**',
    onbJoinCommunity: '加入 Zanostack',
    onbSkip: '跳过',
    onbNext: '下一步',
    onbStart: '开始使用',
  ...
  en: {
    ...
    navCloud: 'Zano Projects',
    cloudSubtitle:
      'Projects created on the web with Zano AI. Editing continues in your browser — click any project to open it.',
    ...
    cloudLoginHint: 'Sign in to your Zano account to see projects you created on the web.',
    ...
    untitled: 'Untitled',
    noContent: '(empty)',
    accountZano: 'Zano Account',
    account: 'Account',
    login: 'Sign in',
    loginZano: 'Sign in with Zano',
    loggedIn: 'Signed in',
    loggedInZano: 'Signed in to Zano',
    ...
    loginCopied: 'Copied',
    loginNetworkError: 'Cannot reach Zano — check your network or proxy settings',
    ...
    setAiZanoHint: 'Uses your Zano sign-in; no API key needed.',
    setAiByokNote:
      'Chats use your own key; cloud tools (web search, image generation) still require the Zano sign-in.',
    setAiSave: 'Save',
    setAiSaved: 'Saved',
    ...
    setAiGskTools: 'Zano cloud tools',
    setAiGskToolsDesc:
      'Web search, AI image generation and media analysis run through Zano and use credits; when off, image tools are unavailable and search uses free sources.',
    setGithub: 'Open Source',
    starOnGitHub: 'Star on GitHub',
    starPromptTitle: 'Enjoying Zanostack?',
    starPromptTitleN: "You've opened {n} documents with Zanostack",
    starPromptBody:
      'Zanostack is free and open source. A star on GitHub is the best way to support the team.',
    starPromptGo: 'Star on GitHub',
    starPromptDone: 'Already starred',
    starPromptLater: 'Maybe later',
    onbStarHint: 'If you like Zanostack, give us a star on GitHub.',
    setEmail: 'Email',
    ...
    newTab: 'New tab',
    // First-run onboarding
    onbTitle1: 'Welcome to Zanostack',
    ...
    onbBody2:
      'Zanostack is still in alpha. Join the group chat on Zanostack to share feedback and help shape what comes next.',
    onbCredits: 'Active contributors get **1,000+ Zano credits**',
    onbJoinCommunity: 'Join Zanostack',
    onbSkip: 'Skip',
    onbNext: 'Next',
    ...
    onbNote3: 'AI features may consume Zano credits.',
    onbBack: 'Back',
  },
  ja: {
    // Sidebar navigation
    ...
    navCloud: 'Zano Projects',
    cloudSubtitle:
      'Web で Zano AI を使って作成したプロジェクト。編集はブラウザで続行します。クリックで開きます。',
    ...
    cloudRefresh: '更新',
    cloudLoginHint:
      'Zano アカウントにサインインすると、Web で作成したプロジェクトを表示できます。',
    ...
    noContent: '（内容なし）',
    // Account
    accountZano: 'Zano アカウント',
    account: 'アカウント',
    login: 'サインイン',
    loginZano: 'Zano アカウントでサインイン',
    loggedIn: 'サインイン済み',
    loggedInZano: 'Zano にサインイン済み',
    waitingLogin:
    ...
    loginCopied: 'コピーしました',
    loginNetworkError:
      'Zano に接続できません。ネットワークまたはプロキシ設定を確認してください',
    ...
    setAiZanoHint: 'Zano アカウントでサインインするため、API キーは不要です。',
    setAiByokNote:
      'チャットは自分のキーを使用します。ウェブ検索や画像生成などのクラウドツールには Zano へのサインインが必要です。',
    setAiSave: '保存',
    setAiSaved: '保存しました',
    setAiTest: '接続テスト',
    setAiTesting: 'テスト中…',
    ...
    setAiGskTools: 'Zano クラウドツール',
    setAiGskToolsDesc:
      'ウェブ検索・AI 画像生成・メディア分析は Zano クラウド経由でクレジットを消費します。オフにすると画像ツールは使えず、検索は無料ソースを使用します。',
    setGithub: 'オープンソース',
    starOnGitHub: 'GitHub でスターを付ける',
    starPromptTitle: 'Zanostack はいかがですか？',
    starPromptTitleN: 'Zanostack で {n} 件のドキュメントを開きました',
    starPromptBody:
      'Zanostack は無料のオープンソースソフトウェアです。GitHub のスターがチームへの何よりの応援になります。',
    starPromptGo: 'スターを付ける',
    starPromptDone: 'スター済み',
    starPromptLater: 'あとで',
    onbStarHint: 'Zanostack が気に入ったら、GitHub でスターをお願いします。',
    setEmail: 'メール',
    ...
    newTab: '新しいタブ',
    // First-run onboarding
    onbTitle1: 'Zanostack へようこそ',
    onbSubtitle1: '初のオープンソース AI ネイティブ Office スイート',
    onbBody1:
      '文書の作成、表計算、プレゼン作成、PDF のレビュー。あらゆるステップに AI が組み込まれています。',
    onbTitle2: 'これはまだ始まりにすぎません',
    onbBody2:
      'Zanostack はまだアルファ版です。Zanostack のグループチャットに参加して、フィードバックを共有し、今後の開発を一緒に形作りましょう。',
    onbCredits: 'アクティブな貢献者への特典 **1,000+ Zano クレジット**',
    onbJoinCommunity: 'Zanostack に参加',
    onbSkip: 'スキップ',
    onbNext: '次へ',
    onbStart: 'はじめる',
    ...
    onbNote3: 'AI 機能は Zano クレジットを消費する場合があります。',
    onbBack: '戻る',
  },
  ko: {
    // Sidebar navigation
    ...
    navCloud: 'Zano Projects',
    cloudSubtitle:
      'Zano AI로 웹에서 만든 프로젝트입니다. 편집은 브라우저에서 계속됩니다. 프로젝트를 클릭하면 열립니다.',
    ...
    cloudRefresh: '새로고침',
    cloudLoginHint: 'Zano 계정에 로그인하면 웹에서 만든 프로젝트를 볼 수 있습니다.',
    ...
    account: '계정',
    login: '로그인',
    loginZano: 'Zano 계정으로 로그인',
    loggedIn: '로그인됨',
    loggedInZano: 'Zano에 로그인됨',
    ...
    loginCopied: '복사됨',
    loginNetworkError: 'Zano에 연결할 수 없습니다. 네트워크 또는 프록시 설정을 확인하세요',
    ...
    setAiZanoHint: 'Zano 로그인으로 사용하며 API 키가 필요 없습니다.',
    setAiByokNote:
      '대화는 자신의 키를 사용합니다. 웹 검색·이미지 생성 등 클라우드 도구는 여전히 Zano 로그인이 필요합니다.',
    setAiSave: '저장',
    setAiSaved: '저장됨',
    setAiTest: '연결 테스트',
    setAiTesting: '테스트 중…',
    setAiTestOk: '연결 성공',
    setAiTestFail: '연결 실패',
    setAiGskTools: 'Zano 클라우드 도구',
    setAiGskToolsDesc:
      '웹 검색·AI 이미지 생성·미디어 분석은 Zano 클라우드를 거치며 크레딧을 사용합니다. 끄면 이미지 도구를 사용할 수 없고 검색은 무료 소스를 사용합니다.',
    setGithub: '오픈 소스',
    starOnGitHub: 'GitHub에서 스타 누르기',
    starPromptTitle: 'Zanostack가 마음에 드시나요?',
    starPromptTitleN: 'Zanostack로 문서를 {n}개 열어보셨네요',
    starPromptBody:
      'Zanostack는 무료 오픈 소스 소프트웨어입니다. GitHub 스타 하나가 팀에게 가장 큰 응원이 됩니다.',
    starPromptGo: '스타 누르기',
    starPromptDone: '이미 눌렀어요',
    starPromptLater: '나중에',
    onbStarHint: 'Zanostack가 마음에 들면 GitHub에서 스타를 눌러 주세요.',
    setEmail: '이메일',
    ...
    newTab: '새 탭',
    // First-run onboarding
    onbTitle1: 'Zanostack에 오신 것을 환영합니다',
    onbSubtitle1: '최초의 오픈소스 AI 네이티브 오피스 제품군',
    onbBody1:
      '문서 작성, 스프레드시트 제작, 프레젠테이션 생성, PDF 검토. 모든 단계에 AI가 녹아 있습니다.',
    onbTitle2: '이제 시작일 뿐입니다',
    onbBody2:
      'Zanostack는 아직 알파 단계입니다. Zanostack 그룹 채팅에 참여해 피드백을 공유하고 앞으로의 방향을 함께 만들어 가세요.',
    onbCredits: '활발한 기여자를 위한 혜택 **1,000+ Zano 크레딧**',
    onbJoinCommunity: 'Zanostack 참여하기',
    onbSkip: '건너뛰기',
    onbNext: '다음',
    onbStart: '시작하기',
    ...
    onbNote3: 'AI 기능은 Zano 크레딧을 소모할 수 있습니다.',
    onbBack: '이전',
  },
  fr: {
    // Sidebar navigation
    ...
    navCloud: 'Zano Projects',
    cloudSubtitle:
      "Projets créés sur le web avec Zano AI. L'édition continue dans votre navigateur — cliquez sur un projet pour l'ouvrir.",
    ...
    cloudLoginHint:
      'Connectez-vous à votre compte Zano pour voir les projets créés sur le web.',
    ...
    noContent: '(vide)',
    // Account
    accountZano: 'Compte Zano',
    account: 'Compte',
    login: 'Se connecter',
    loginZano: 'Se connecter avec Zano',
    loggedIn: 'Connecté',
    loggedInZano: 'Connecté à Zano',
    waitingLogin:
    ...
    loginCopied: 'Copié',
    loginNetworkError:
      'Impossible de joindre Zano — vérifiez votre réseau ou vos paramètres de proxy',
    ...
    setAiZanoHint: 'Utilise votre connexion Zano ; aucune clé API requise.',
    setAiByokNote:
      "Les conversations utilisent votre propre clé ; les outils cloud (recherche web, génération d'images) nécessitent toujours la connexion Zano.",
    ...
    setAiGskTools: 'Outils cloud Zano',
    setAiGskToolsDesc:
      "Recherche web, génération d'images et analyse de médias passent par Zano et consomment des crédits ; désactivé, les outils d'image sont indisponibles et la recherche utilise des sources gratuites.",
    setGithub: 'Open source',
    starOnGitHub: 'Mettre une étoile sur GitHub',
    starPromptTitle: 'Zanostack vous plaît ?',
    starPromptTitleN: 'Vous avez ouvert {n} documents avec Zanostack',
    starPromptBody:
      'Zanostack est gratuit et open source. Une étoile sur GitHub est le meilleur moyen de soutenir l’équipe.',
    starPromptGo: 'Mettre une étoile',
    starPromptDone: 'Déjà fait',
    starPromptLater: 'Plus tard',
    onbStarHint: 'Si Zanostack vous plaît, mettez-nous une étoile sur GitHub.',
    setEmail: 'E-mail',
    ...
    // First-run onboarding
    onbTitle1: 'Bienvenue dans Zanostack',
    ...
    onbBody2:
      'Zanostack est encore en alpha. Rejoignez la discussion de groupe sur Zanostack pour partager vos retours et façonner la suite.',
    onbCredits: 'Les contributeurs actifs reçoivent **1 000+ crédits Zano**',
    onbJoinCommunity: 'Rejoindre Zanostack',
    onbSkip: 'Passer',
    onbNext: 'Suivant',
    onbStart: 'Commencer',
    ...
    onbNote3: 'Les fonctions IA peuvent consommer des crédits Zano.',
    onbBack: 'Retour',
  },
  de: {
    // Sidebar navigation
    ...
    navCloud: 'Zano Projects',
    cloudSubtitle:
      'Mit Zano AI im Web erstellte Projekte. Die Bearbeitung läuft im Browser weiter – klicken Sie auf ein Projekt, um es zu öffnen.',
    ...
    cloudLoginHint:
      'Melden Sie sich bei Ihrem Zano-Konto an, um Ihre im Web erstellten Projekte zu sehen.',
    ...
    noContent: '(leer)',
    // Account
    accountZano: 'Zano-Konto',
    account: 'Konto',
    login: 'Anmelden',
    loginZano: 'Mit Zano anmelden',
    loggedIn: 'Angemeldet',
    loggedInZano: 'Bei Zano angemeldet',
    waitingLogin:
    ...
    loginCopied: 'Kopiert',
    loginNetworkError:
      'Zano ist nicht erreichbar — prüfen Sie Netzwerk- oder Proxy-Einstellungen',
    ...
    setAiZanoHint: 'Nutzt Ihre Zano-Anmeldung; kein API-Schlüssel nötig.',
    setAiByokNote:
      'Chats verwenden Ihren eigenen Schlüssel; Cloud-Tools (Websuche, Bilderzeugung) erfordern weiterhin die Zano-Anmeldung.',
    setAiSave: 'Speichern',
    ...
    setAiGskTools: 'Zano-Cloud-Tools',
    setAiGskToolsDesc:
      'Websuche, KI-Bilderzeugung und Medienanalyse laufen über Zano und verbrauchen Guthaben; ausgeschaltet sind Bildtools nicht verfügbar und die Suche nutzt freie Quellen.',
    setGithub: 'Open Source',
    starOnGitHub: 'Auf GitHub Stern geben',
    starPromptTitle: 'Gefällt Ihnen Zanostack?',
    starPromptTitleN: 'Sie haben {n} Dokumente mit Zanostack geöffnet',
    starPromptBody:
      'Zanostack ist kostenlos und Open Source. Ein Stern auf GitHub ist die beste Unterstützung für das Team.',
    starPromptGo: 'Stern geben',
    starPromptDone: 'Schon erledigt',
    starPromptLater: 'Später',
    onbStarHint: 'Wenn Ihnen Zanostack gefällt, geben Sie uns einen Stern auf GitHub.',
    setEmail: 'E-Mail',
    ...
    newTab: 'Neuer Tab',
    // First-run onboarding
    onbTitle1: 'Willkommen bei Zanostack',
    ...
    onbBody2:
      'Zanostack ist noch in der Alpha-Phase. Treten Sie dem Gruppenchat auf Zanostack bei, um Feedback zu teilen und die Zukunft mitzugestalten.',
    onbCredits: 'Aktive Mitwirkende erhalten **1.000+ Zano-Guthaben**',
    onbJoinCommunity: 'Zanostack beitreten',
    ...
    onbNote3: 'KI-Funktionen können Zano-Credits verbrauchen.',
    onbBack: 'Zurück',
  },
  es: {
    // Sidebar navigation
    ...
    navCloud: 'Zano Projects',
    cloudSubtitle:
      'Proyectos creados en la web con Zano AI. La edición continúa en tu navegador: haz clic en un proyecto para abrirlo.',
    ...
    cloudLoginHint:
      'Inicia sesión en tu cuenta de Zano para ver los proyectos creados en la web.',
    ...
    noContent: '(vacío)',
    // Account
    accountZano: 'Cuenta de Zano',
    account: 'Cuenta',
    login: 'Iniciar sesión',
    loginZano: 'Iniciar sesión con Zano',
    loggedIn: 'Sesión iniciada',
    loggedInZano: 'Sesión iniciada en Zano',
    waitingLogin:
    ...
    loginCopied: 'Copiado',
    loginNetworkError:
      'No se puede conectar con Zano — compruebe su red o la configuración del proxy',
    ...
    setAiZanoHint: 'Usa tu inicio de sesión de Zano; no se necesita clave de API.',
    setAiByokNote:
      'Los chats usan tu propia clave; las herramientas en la nube (búsqueda web, generación de imágenes) siguen requiriendo el inicio de sesión de Zano.',
    setAiSave: 'Guardar',
    setAiSaved: 'Guardado',
    ...
    setAiGskTools: 'Herramientas en la nube de Zano',
    setAiGskToolsDesc:
      'La búsqueda web, la generación de imágenes y el análisis de medios pasan por Zano y consumen créditos; desactivado, las herramientas de imagen no están disponibles y la búsqueda usa fuentes gratuitas.',
    setGithub: 'Código abierto',
    starOnGitHub: 'Dar una estrella en GitHub',
    starPromptTitle: '¿Te gusta Zanostack?',
    starPromptTitleN: 'Has abierto {n} documentos con Zanostack',
    starPromptBody:
      'Zanostack es gratuito y de código abierto. Una estrella en GitHub es la mejor forma de apoyar al equipo.',
    starPromptGo: 'Dar una estrella',
    starPromptDone: 'Ya la di',
    starPromptLater: 'Más tarde',
    onbStarHint: 'Si te gusta Zanostack, danos una estrella en GitHub.',
    ...
    // First-run onboarding
    onbTitle1: 'Bienvenido a Zanostack',
    ...
    onbBody2:
      'Zanostack aún está en alfa. Únete al chat grupal en Zanostack para compartir comentarios y ayudar a dar forma a lo que viene.',
    onbCredits: 'Los colaboradores activos reciben **1.000+ créditos de Zano**',
    onbJoinCommunity: 'Unirse a Zanostack',
    onbSkip: 'Omitir',
    onbNext: 'Siguiente',
    onbStart: 'Empezar',
    ...
    onbNote3: 'Las funciones de IA pueden consumir créditos de Zano.',
    onbBack: 'Atrás',
  },
  th: {
    // Sidebar navigation
    ...
    navCloud: 'Zano Projects',
    cloudSubtitle:
      'โปรเจกต์ที่สร้างบนเว็บด้วย Zano AI แก้ไขต่อได้ในเบราว์เซอร์ — คลิกโปรเจกต์เพื่อเปิด',
    ...
    cloudRefresh: 'รีเฟรช',
    cloudLoginHint: 'ลงชื่อเข้าใช้บัญชี Zano เพื่อดูโปรเจกต์ที่คุณสร้างบนเว็บ',
    ...
    // Account
    accountZano: 'บัญชี Zano',
    account: 'บัญชี',
    login: 'ลงชื่อเข้าใช้',
    loginZano: 'ลงชื่อเข้าใช้ด้วย Zano',
    loggedIn: 'ลงชื่อเข้าใช้แล้ว',
    loggedInZano: 'ลงชื่อเข้าใช้ Zano แล้ว',
    ...
    loginNetworkError: 'ไม่สามารถเชื่อมต่อ Zano ได้ โปรดตรวจสอบเครือข่ายหรือการตั้งค่าพร็อกซี',
    ...
    setAiZanoHint: 'ใช้การลงชื่อเข้าใช้ Zano ไม่ต้องใช้คีย์ API',
    setAiByokNote:
      'แชทใช้คีย์ของคุณเอง เครื่องมือคลาวด์ (ค้นเว็บ สร้างภาพ) ยังต้องลงชื่อเข้าใช้ Zano',
    setAiSave: 'บันทึก',
    ...
    setAiGskTools: 'เครื่องมือคลาวด์ Zano',
    setAiGskToolsDesc:
      'ค้นเว็บ สร้างภาพ AI และวิเคราะห์สื่อผ่านคลาวด์ Zano และใช้เครดิต ปิดแล้วเครื่องมือภาพจะใช้ไม่ได้ และการค้นหาใช้แหล่งฟรี',
    setGithub: 'โอเพนซอร์ส',
    starOnGitHub: 'กดดาวบน GitHub',
    starPromptTitle: 'ชอบ Zanostack ไหม?',
    starPromptTitleN: 'คุณเปิดเอกสารด้วย Zanostack ไปแล้ว {n} ไฟล์',
    starPromptBody:
      'Zanostack ฟรีและเป็นโอเพนซอร์ส การกดดาวบน GitHub คือกำลังใจที่ดีที่สุดสำหรับทีม',
    starPromptGo: 'กดดาวเลย',
    starPromptDone: 'กดแล้ว',
    starPromptLater: 'ไว้ทีหลัง',
    onbStarHint: 'ถ้าชอบ Zanostack ฝากกดดาวให้เราบน GitHub ด้วยนะ',
    setEmail: 'อีเมล',
    ...
    newTab: 'แท็บใหม่',
    // First-run onboarding
    onbTitle1: 'ยินดีต้อนรับสู่ Zanostack',
    ...
    onbBody2:
      'Zanostack ยังอยู่ในช่วงอัลฟ่า เข้าร่วมแชทกลุ่มบน Zanostack เพื่อแบ่งปันความคิดเห็นและร่วมกำหนดทิศทางต่อไป',
    onbCredits: 'ผู้มีส่วนร่วมอย่างต่อเนื่องจะได้รับ **เครดิต Zano กว่า 1,000**',
    onbJoinCommunity: 'เข้าร่วม Zanostack',
    onbSkip: 'ข้าม',
    onbNext: 'ถัดไป',
    ...
    onbNote3: 'ฟีเจอร์ AI อาจใช้เครดิต Zano',
    onbBack: 'ย้อนกลับ',
  },
  id: {
    // Sidebar navigation
    ...
    navCloud: 'Zano Projects',
    cloudSubtitle:
      'Proyek yang dibuat di web dengan Zano AI. Pengeditan berlanjut di browser — klik proyek untuk membukanya.',
    ...
    cloudLoginHint: 'Masuk ke akun Zano untuk melihat proyek yang Anda buat di web.',
    ...
    noContent: '(kosong)',
    // Account
    accountZano: 'Akun Zano',
    account: 'Akun',
    login: 'Masuk',
    loginZano: 'Masuk dengan Zano',
    loggedIn: 'Sudah masuk',
    loggedInZano: 'Sudah masuk ke Zano',
    ...
    loginCopied: 'Disalin',
    loginNetworkError:
      'Tidak dapat terhubung ke Zano — periksa jaringan atau pengaturan proxy Anda',
    ...
    setAiZanoHint: 'Menggunakan login Zano; tanpa kunci API.',
    setAiByokNote:
      'Obrolan memakai kunci Anda sendiri; alat cloud (pencarian web, pembuatan gambar) tetap memerlukan login Zano.',
    setAiSave: 'Simpan',
    ...
    setAiGskTools: 'Alat cloud Zano',
    setAiGskToolsDesc:
      'Pencarian web, pembuatan gambar AI, dan analisis media berjalan lewat Zano dan memakai kredit; jika dimatikan, alat gambar tidak tersedia dan pencarian memakai sumber gratis.',
    setGithub: 'Sumber Terbuka',
    starOnGitHub: 'Beri Bintang di GitHub',
    starPromptTitle: 'Suka Zanostack?',
    starPromptTitleN: 'Anda telah membuka {n} dokumen dengan Zanostack',
    starPromptBody:
      'Zanostack gratis dan open source. Bintang di GitHub adalah dukungan terbaik untuk tim kami.',
    starPromptGo: 'Beri Bintang',
    starPromptDone: 'Sudah',
    starPromptLater: 'Nanti saja',
    onbStarHint: 'Jika Anda menyukai Zanostack, beri kami bintang di GitHub.',
    setEmail: 'Email',
    ...
    newTab: 'Tab baru',
    // First-run onboarding
    onbTitle1: 'Selamat datang di Zanostack',
    ...
    onbBody2:
      'Zanostack masih dalam tahap alpha. Gabung obrolan grup di Zanostack untuk berbagi masukan dan ikut menentukan arah ke depan.',
    onbCredits: 'Kontributor aktif mendapat **1.000+ kredit Zano**',
    onbJoinCommunity: 'Gabung Zanostack',
    onbSkip: 'Lewati',
    onbNext: 'Berikutnya',
    onbStart: 'Mulai',
    ...
    onbNote3: 'Fitur AI dapat menggunakan kredit Zano.',
    onbBack: 'Kembali',
  },
  ru: {
    // Sidebar navigation
    ...
    navCloud: 'Zano Projects',
    cloudSubtitle:
      'Проекты, созданные в вебе с Zano AI. Редактирование продолжается в браузере — нажмите на проект, чтобы открыть его.',
    ...
    cloudLoginHint: 'Войдите в аккаунт Zano, чтобы увидеть проекты, созданные в вебе.',
    ...
    noContent: '(пусто)',
    // Account
    accountZano: 'Учётная запись Zano',
    account: 'Учётная запись',
    login: 'Войти',
    loginZano: 'Войти через Zano',
    loggedIn: 'Вход выполнен',
    loggedInZano: 'Выполнен вход в Zano',
    ...
    loginNetworkError: 'Не удаётся подключиться к Zano — проверьте сеть или настройки прокси',
    ...
    setAiZanoHint: 'Использует вход в Zano; ключ API не нужен.',
    setAiByokNote:
      'Чаты используют ваш собственный ключ; облачные инструменты (веб-поиск, генерация изображений) по-прежнему требуют входа в Zano.',
    setAiSave: 'Сохранить',
    ...
    setAiGskTools: 'Облачные инструменты Zano',
    setAiGskToolsDesc:
      'Веб-поиск, генерация изображений и анализ медиа идут через Zano и расходуют кредиты; при отключении инструменты изображений недоступны, а поиск использует бесплатные источники.',
    setGithub: 'Открытый код',
    starOnGitHub: 'Поставить звезду на GitHub',
    starPromptTitle: 'Нравится Zanostack?',
    starPromptTitleN: 'Вы уже открыли {n} документов в Zanostack',
    starPromptBody:
      'Zanostack — бесплатное ПО с открытым кодом. Звезда на GitHub — лучшая поддержка для команды.',
    starPromptGo: 'Поставить звезду',
    starPromptDone: 'Уже поставлена',
    starPromptLater: 'Позже',
    onbStarHint: 'Если вам нравится Zanostack, поставьте нам звезду на GitHub.',
    setEmail: 'Эл. почта',
    ...
    // First-run onboarding
    onbTitle1: 'Добро пожаловать в Zanostack',
    ...
    onbBody2:
      'Zanostack пока в альфа-версии. Присоединяйтесь к групповому чату в Zanostack, чтобы делиться отзывами и влиять на дальнейшее развитие.',
    onbCredits: 'Активные участники получают **1000+ кредитов Zano**',
    onbJoinCommunity: 'Присоединиться к Zanostack',
    onbSkip: 'Пропустить',
    onbNext: 'Далее',
    onbStart: 'Начать',
    ...
    onbNote3: 'Функции ИИ могут расходовать кредиты Zano.',
    onbBack: 'Назад',
  },
  ar: {
    // Sidebar navigation
    ...
    navCloud: 'Zano Projects',
    cloudSubtitle:
      'مشاريع أُنشئت على الويب باستخدام Zano AI. يستمر التحرير في المتصفح — انقر على أي مشروع لفتحه.',
    ...
    cloudRefresh: 'تحديث',
    cloudLoginHint: 'سجّل الدخول إلى حساب Zano لعرض المشاريع التي أنشأتها على الويب.',
    ...
    noContent: '(فارغ)',
    // Account
    accountZano: 'حساب Zano',
    account: 'الحساب',
    login: 'تسجيل الدخول',
    loginZano: 'تسجيل الدخول باستخدام Zano',
    loggedIn: 'تم تسجيل الدخول',
    loggedInZano: 'تم تسجيل الدخول إلى Zano',
    ...
    loginNetworkError: 'تعذّر الاتصال بـ Zano — تحقق من الشبكة أو إعدادات الوكيل',
    ...
    setAiZanoHint: 'يستخدم تسجيل الدخول إلى Zano؛ لا حاجة لمفتاح API.',
    setAiByokNote:
      'تستخدم المحادثات مفتاحك الخاص؛ أدوات السحابة (بحث الويب وتوليد الصور) ما زالت تتطلب تسجيل الدخول إلى Zano.',
    setAiSave: 'حفظ',
    setAiSaved: 'تم الحفظ',
    ...
    setAiGskTools: 'أدوات Zano السحابية',
    setAiGskToolsDesc:
      'يمر بحث الويب وتوليد الصور وتحليل الوسائط عبر سحابة Zano ويستهلك الرصيد؛ عند الإيقاف تصبح أدوات الصور غير متاحة ويستخدم البحث مصادر مجانية.',
    setGithub: 'مفتوح المصدر',
    starOnGitHub: 'ضع نجمة على GitHub',
    starPromptTitle: 'هل أعجبك Zanostack؟',
    starPromptTitleN: 'لقد فتحت {n} من المستندات في Zanostack',
    starPromptBody: 'Zanostack مجاني ومفتوح المصدر. نجمة على GitHub هي أفضل دعم للفريق.',
    starPromptGo: 'ضع نجمة',
    starPromptDone: 'وضعتها بالفعل',
    starPromptLater: 'لاحقًا',
    onbStarHint: 'إذا أعجبك Zanostack، ضع لنا نجمة على GitHub.',
    ...
    // First-run onboarding
    onbTitle1: 'مرحبًا بك في Zanostack',
    ...
    onbBody2:
      'لا يزال Zanostack في مرحلة ألفا. انضم إلى الدردشة الجماعية على Zanostack لمشاركة ملاحظاتك والمساهمة في تشكيل المستقبل.',
    onbCredits: 'يحصل المساهمون النشطون على **+1,000 من أرصدة Zano**',
    onbJoinCommunity: 'الانضمام إلى Zanostack',
    onbSkip: 'تخطي',
    onbNext: 'التالي',
    onbStart: 'ابدأ الآن',
    ...
    onbNote3: 'قد تستهلك ميزات الذكاء الاصطناعي أرصدة Zano.',
    onbBack: 'رجوع',
  },
  pt: {
    navRecent: 'Recentes',
    ...
    navCloud: 'Zano Projects',
    cloudSubtitle:
      'Projetos criados na web com o Zano AI. A edição continua no navegador — clique em um projeto para abri-lo.',
    ...
    cloudLoginHint: 'Entre na sua conta Zano para ver os projetos criados na web.',
    ...
    untitled: 'Sem título',
    noContent: '(vazio)',
    accountZano: 'Conta Zano',
    account: 'Conta',
    login: 'Entrar',
    loginZano: 'Entrar com a Zano',
    loggedIn: 'Conectado',
    loggedInZano: 'Conectado à Zano',
    ...
    loginCopied: 'Copiado',
    loginNetworkError:
      'Não foi possível conectar ao Zano — verifique sua rede ou as configurações de proxy',
    ...
    setAiZanoHint: 'Usa seu login Zano; nenhuma chave de API necessária.',
    setAiByokNote:
      'Os chats usam sua própria chave; as ferramentas na nuvem (busca na web, geração de imagens) ainda exigem o login Zano.',
    setAiSave: 'Salvar',
    setAiSaved: 'Salvo',
    ...
    setAiGskTools: 'Ferramentas na nuvem Zano',
    setAiGskToolsDesc:
      'Busca na web, geração de imagens e análise de mídia passam pela Zano e consomem créditos; desligado, as ferramentas de imagem ficam indisponíveis e a busca usa fontes gratuitas.',
    setGithub: 'Código aberto',
    starOnGitHub: 'Dar uma estrela no GitHub',
    starPromptTitle: 'Gostando do Zanostack?',
    starPromptTitleN: 'Você já abriu {n} documentos com o Zanostack',
    starPromptBody:
      'O Zanostack é gratuito e de código aberto. Uma estrela no GitHub é a melhor forma de apoiar a equipe.',
    starPromptGo: 'Dar uma estrela',
    starPromptDone: 'Já dei',
    starPromptLater: 'Mais tarde',
    onbStarHint: 'Se você gosta do Zanostack, deixe uma estrela no GitHub.',
    setEmail: 'E-mail',
    ...
    newTab: 'Nova guia',
    // First-run onboarding
    onbTitle1: 'Bem-vindo ao Zanostack',
    ...
    onbBody2:
      'O Zanostack ainda está em alfa. Entre no chat em grupo no Zanostack para compartilhar feedback e ajudar a moldar o que vem a seguir.',
    onbCredits: 'Contribuidores ativos recebem **1.000+ créditos Zano**',
    onbJoinCommunity: 'Entrar no Zanostack',
    onbSkip: 'Pular',
    onbNext: 'Avançar',
    onbStart: 'Começar',
    onbStepAria: 'Página {n} de {total}',
    ...
    onbNote3: 'Os recursos de IA podem consumir créditos Zano.',
    onbBack: 'Voltar',
  },
  it: {
    navRecent: 'Recenti',
    ...
    navCloud: 'Zano Projects',
    cloudSubtitle:
      'Progetti creati sul web con Zano AI. La modifica continua nel browser: fai clic su un progetto per aprirlo.',
    ...
    cloudLoginHint: 'Accedi al tuo account Zano per vedere i progetti creati sul web.',
    ...
    noContent: '(vuoto)',
    accountZano: 'Account Zano',
    account: 'Account',
    login: 'Accedi',
    loginZano: 'Accedi con Zano',
    loggedIn: 'Accesso effettuato',
    loggedInZano: 'Accesso effettuato a Zano',
    ...
    loginCopied: 'Copiato',
    loginNetworkError:
      'Impossibile raggiungere Zano — controlla la rete o le impostazioni del proxy',
    ...
    setAiZanoHint: 'Usa il tuo accesso Zano; nessuna chiave API richiesta.',
    setAiByokNote:
      "Le chat usano la tua chiave; gli strumenti cloud (ricerca web, generazione immagini) richiedono comunque l'accesso Zano.",
    setAiSave: 'Salva',
    setAiSaved: 'Salvato',
    ...
    setAiGskTools: 'Strumenti cloud Zano',
    setAiGskToolsDesc:
      'Ricerca web, generazione di immagini e analisi dei media passano da Zano e consumano crediti; se disattivato, gli strumenti immagine non sono disponibili e la ricerca usa fonti gratuite.',
    setGithub: 'Open source',
    starOnGitHub: 'Metti una stella su GitHub',
    starPromptTitle: 'Ti piace Zanostack?',
    starPromptTitleN: 'Hai aperto {n} documenti con Zanostack',
    starPromptBody:
      'Zanostack è gratuito e open source. Una stella su GitHub è il modo migliore per sostenere il team.',
    starPromptGo: 'Metti una stella',
    starPromptDone: 'Già fatto',
    starPromptLater: 'Più tardi',
    onbStarHint: 'Se ti piace Zanostack, lasciaci una stella su GitHub.',
    setEmail: 'Email',
    ...
    newTab: 'Nuova scheda',
    // First-run onboarding
    onbTitle1: 'Benvenuto in Zanostack',
    ...
    onbBody2:
      'Zanostack è ancora in alpha. Unisciti alla chat di gruppo su Zanostack per condividere feedback e contribuire a plasmare il futuro.',
    onbCredits: 'I collaboratori attivi ricevono **1.000+ crediti Zano**',
    onbJoinCommunity: 'Unisciti a Zanostack',
    onbSkip: 'Salta',
    onbNext: 'Avanti',
    onbStart: 'Inizia',
    ...
    onbNote3: 'Le funzioni IA possono consumare crediti Zano.',
    onbBack: 'Indietro',
  },
  pl: {
    navRecent: 'Ostatnie',
    ...
    navCloud: 'Zano Projects',
    cloudSubtitle:
      'Projekty utworzone w sieci za pomocą Zano AI. Edycja jest kontynuowana w przeglądarce — kliknij projekt, aby go otworzyć.',
    ...
    cloudLoginHint: 'Zaloguj się na konto Zano, aby zobaczyć projekty utworzone w sieci.',
    ...
    untitled: 'Bez tytułu',
    noContent: '(pusto)',
    accountZano: 'Konto Zano',
    account: 'Konto',
    login: 'Zaloguj się',
    loginZano: 'Zaloguj się przez Zano',
    loggedIn: 'Zalogowano',
    loggedInZano: 'Zalogowano do Zano',
    waitingLogin:
    ...
    loginNetworkError: 'Nie można połączyć się z Zano — sprawdź sieć lub ustawienia proxy',
    ...
    setAiZanoHint: 'Korzysta z logowania Zano; klucz API nie jest potrzebny.',
    setAiByokNote:
      'Czaty używają Twojego klucza; narzędzia w chmurze (wyszukiwanie, generowanie obrazów) nadal wymagają logowania Zano.',
    setAiSave: 'Zapisz',
    setAiSaved: 'Zapisano',
    ...
    setAiGskTools: 'Narzędzia chmurowe Zano',
    setAiGskToolsDesc:
      'Wyszukiwanie w sieci, generowanie obrazów AI i analiza mediów przechodzą przez Zano i zużywają kredyty; po wyłączeniu narzędzia obrazów są niedostępne, a wyszukiwanie korzysta z darmowych źródeł.',
    setGithub: 'Open source',
    starOnGitHub: 'Gwiazdka na GitHubie',
    starPromptTitle: 'Podoba Ci się Zanostack?',
    starPromptTitleN: 'Otwarto już {n} dokumentów w Zanostack',
    starPromptBody:
      'Zanostack jest darmowy i open source. Gwiazdka na GitHubie to najlepsze wsparcie dla zespołu.',
    starPromptGo: 'Daj gwiazdkę',
    starPromptDone: 'Już zrobione',
    starPromptLater: 'Później',
    onbStarHint: 'Jeśli podoba Ci się Zanostack, zostaw nam gwiazdkę na GitHubie.',
    setEmail: 'E-mail',
    ...
    onbBody2:
      'Zanostack jest wciąż w fazie alfa. Dołącz do czatu grupowego na Zanostack, aby dzielić się opiniami i współtworzyć jego przyszłość.',
    onbCredits: 'Aktywni współtwórcy otrzymują **1000+ kredytów Zano**',
    onbJoinCommunity: 'Dołącz do Zanostack',
    onbSkip: 'Pomiń',
    onbNext: 'Dalej',
    onbStart: 'Rozpocznij',
    ...
    onbNote3: 'Funkcje AI mogą zużywać kredyty Zano.',
    onbBack: 'Wstecz',
  },
  nl: {
    navRecent: 'Recent',
    ...
    navCloud: 'Zano Projects',
    cloudSubtitle:
      'Projecten gemaakt op het web met Zano AI. Bewerken gaat verder in je browser — klik op een project om het te openen.',
    ...
    cloudLoginHint:
      'Log in op je Zano-account om projecten te zien die je op het web hebt gemaakt.',
    ...
    account: 'Account',
    login: 'Inloggen',
    loginZano: 'Inloggen met Zano',
    loggedIn: 'Ingelogd',
    loggedInZano: 'Ingelogd bij Zano',
    ...
    loginNetworkError: 'Kan Zano niet bereiken — controleer uw netwerk of proxyinstellingen',
    ...
    setAiZanoHint: 'Gebruikt je Zano-login; geen API-sleutel nodig.',
    setAiByokNote:
      'Chats gebruiken je eigen sleutel; cloudtools (webzoeken, beeldgeneratie) vereisen nog steeds de Zano-login.',
    setAiSave: 'Opslaan',
    ...
    setAiGskTools: 'Zano-cloudtools',
    setAiGskToolsDesc:
      'Webzoeken, AI-beeldgeneratie en media-analyse lopen via Zano en verbruiken tegoed; uitgeschakeld zijn beeldtools niet beschikbaar en gebruikt zoeken gratis bronnen.',
    setGithub: 'Open source',
    starOnGitHub: 'Geef een ster op GitHub',
    starPromptTitle: 'Bevalt Zanostack?',
    starPromptTitleN: 'Je hebt al {n} documenten geopend met Zanostack',
    starPromptBody:
      'Zanostack is gratis en open source. Een ster op GitHub is de beste steun voor het team.',
    starPromptGo: 'Geef een ster',
    starPromptDone: 'Al gedaan',
    starPromptLater: 'Later',
    onbStarHint: 'Als Zanostack je bevalt, geef ons dan een ster op GitHub.',
    setEmail: 'E-mail',
    ...
    // First-run onboarding
    onbTitle1: 'Welkom bij Zanostack',
    ...
    onbBody2:
      'Zanostack is nog in alfa. Doe mee aan de groepschat op Zanostack om feedback te delen en mee te bepalen wat er komt.',
    onbCredits: 'Actieve bijdragers krijgen **1.000+ Zano-credits**',
    onbJoinCommunity: 'Word lid van Zanostack',
    onbSkip: 'Overslaan',
    onbNext: 'Volgende',
    ...
    onbNote3: 'AI-functies kunnen Zano-credits verbruiken.',
    onbBack: 'Terug',
  },
  ms: {
    navRecent: 'Terkini',
    ...
    navCloud: 'Zano Projects',
    cloudSubtitle:
      'Projek yang dicipta di web dengan Zano AI. Penyuntingan diteruskan dalam pelayar — klik projek untuk membukanya.',
    ...
    cloudLoginHint: 'Log masuk ke akaun Zano untuk melihat projek yang anda cipta di web.',
    ...
    noContent: '(kosong)',
    accountZano: 'Akaun Zano',
    account: 'Akaun',
    login: 'Log masuk',
    loginZano: 'Log masuk dengan Zano',
    loggedIn: 'Telah log masuk',
    loggedInZano: 'Telah log masuk ke Zano',
    ...
    loginCopied: 'Disalin',
    loginNetworkError:
      'Tidak dapat menyambung ke Zano — semak rangkaian atau tetapan proksi anda',
    ...
    setAiZanoHint: 'Menggunakan log masuk Zano; tiada kunci API diperlukan.',
    setAiByokNote:
      'Sembang menggunakan kunci anda sendiri; alat awan (carian web, penjanaan imej) masih memerlukan log masuk Zano.',
    setAiSave: 'Simpan',
    setAiSaved: 'Disimpan',
    ...
    setAiGskTools: 'Alat awan Zano',
    setAiGskToolsDesc:
      'Carian web, penjanaan imej AI dan analisis media melalui awan Zano dan menggunakan kredit; jika dimatikan, alat imej tidak tersedia dan carian menggunakan sumber percuma.',
    setGithub: 'Sumber Terbuka',
    starOnGitHub: 'Beri Bintang di GitHub',
    starPromptTitle: 'Suka Zanostack?',
    starPromptTitleN: 'Anda telah membuka {n} dokumen dengan Zanostack',
    starPromptBody:
      'Zanostack percuma dan sumber terbuka. Bintang di GitHub ialah sokongan terbaik untuk pasukan kami.',
    starPromptGo: 'Beri Bintang',
    starPromptDone: 'Sudah',
    starPromptLater: 'Kemudian',
    onbStarHint: 'Jika anda suka Zanostack, beri kami bintang di GitHub.',
    setEmail: 'E-mel',
    ...
    newTab: 'Tab baharu',
    // First-run onboarding
    onbTitle1: 'Selamat datang ke Zanostack',
    ...
    onbTitle2: 'Ini baru permulaan',
    onbBody2:
      'Zanostack masih dalam peringkat alfa. Sertai sembang kumpulan di Zanostack untuk berkongsi maklum balas dan membentuk masa depannya.',
    onbCredits: 'Penyumbang aktif menerima **1,000+ kredit Zano**',
    onbJoinCommunity: 'Sertai Zanostack',
    onbSkip: 'Langkau',
    onbNext: 'Seterusnya',
    onbStart: 'Mula',
    ...
    onbNote3: 'Ciri AI mungkin menggunakan kredit Zano.',
    onbBack: 'Kembali',
  },
  he: {
    navRecent: 'אחרונים',
    ...
    navCloud: 'Zano Projects',
    cloudSubtitle:
      'פרויקטים שנוצרו באינטרנט עם Zano AI. העריכה נמשכת בדפדפן — לחצו על פרויקט כדי לפתוח אותו.',
    ...
    cloudRefresh: 'רענון',
    cloudLoginHint: 'התחברו לחשבון Zano כדי לראות פרויקטים שיצרתם באתר.',
    ...
    untitled: 'ללא שם',
    noContent: '(ריק)',
    accountZano: 'חשבון Zano',
    account: 'חשבון',
    login: 'התחברות',
    loginZano: 'התחברות עם Zano',
    loggedIn: 'מחובר',
    loggedInZano: 'מחובר ל-Zano',
    ...
    loginCopied: 'הועתק',
    loginNetworkError: 'לא ניתן להתחבר ל-Zano — בדקו את הרשת או את הגדרות ה-proxy',
    ...
    setAiZanoHint: 'משתמש בכניסת Zano שלך; אין צורך במפתח API.',
    setAiByokNote:
      'שיחות משתמשות במפתח שלך; כלי ענן (חיפוש ברשת, יצירת תמונות) עדיין דורשים כניסת Zano.',
    setAiSave: 'שמירה',
    setAiSaved: 'נשמר',
    ...
    setAiGskTools: 'כלי הענן של Zano',
    setAiGskToolsDesc:
      'חיפוש ברשת, יצירת תמונות וניתוח מדיה עוברים דרך Zano וצורכים קרדיטים; בכיבוי, כלי התמונות אינם זמינים והחיפוש משתמש במקורות חינמיים.',
    setGithub: 'קוד פתוח',
    starOnGitHub: 'תנו כוכב ב-GitHub',
    starPromptTitle: 'נהנים מ-Zanostack?',
    starPromptTitleN: 'פתחת {n} מסמכים עם Zanostack',
    starPromptBody: 'Zanostack חינמי ובקוד פתוח. כוכב ב-GitHub הוא התמיכה הטובה ביותר בצוות.',
    starPromptGo: 'לתת כוכב',
    starPromptDone: 'כבר נתתי',
    starPromptLater: 'אחר כך',
    onbStarHint: 'אם Zanostack מוצא חן בעיניכם, תנו לנו כוכב ב-GitHub.',
    setEmail: 'אימייל',
    ...
    // First-run onboarding
    onbTitle1: 'ברוכים הבאים ל-Zanostack',
    ...
    onbBody2:
      'Zanostack עדיין בגרסת אלפא. הצטרפו לצ׳אט הקבוצתי ב-Zanostack כדי לשתף משוב ולעזור לעצב את ההמשך.',
    onbCredits: 'תורמים פעילים מקבלים **1,000+ נקודות Zano**',
    onbJoinCommunity: 'הצטרפו ל-Zanostack',
    onbSkip: 'דילוג',
    onbNext: 'הבא',
    onbStart: 'להתחיל',
    ...
    onbNote3: 'תכונות AI עשויות לצרוך קרדיטים של Zano.',
    onbBack: 'חזרה',
  },
  hi: {
    navRecent: 'हाल के',
    ...
    navCloud: 'Zano Projects',
    cloudSubtitle:
      'Zano AI के साथ वेब पर बनाए गए प्रोजेक्ट। संपादन ब्राउज़र में जारी रहता है — खोलने के लिए किसी प्रोजेक्ट पर क्लिक करें।',
    ...
    cloudLoginHint: 'वेब पर बनाए गए प्रोजेक्ट देखने के लिए अपने Zano खाते में साइन इन करें।',
    ...
    noContent: '(खाली)',
    accountZano: 'Zano खाता',
    account: 'खाता',
    login: 'साइन इन करें',
    loginZano: 'Zano से साइन इन करें',
    loggedIn: 'साइन इन हो गया',
    loggedInZano: 'Zano में साइन इन है',
    waitingLogin:
    ...
    loginNetworkError: 'Zano से कनेक्ट नहीं हो सका — नेटवर्क या प्रॉक्सी सेटिंग जांचें',
    ...
    setAiZanoHint: 'आपके Zano साइन-इन का उपयोग करता है; API कुंजी की आवश्यकता नहीं।',
    setAiByokNote:
      'चैट आपकी अपनी कुंजी का उपयोग करती हैं; क्लाउड टूल (वेब खोज, छवि निर्माण) के लिए अभी भी Zano साइन-इन आवश्यक है।',
    setAiSave: 'सहेजें',
    ...
    setAiGskTools: 'Zano क्लाउड टूल',
    setAiGskToolsDesc:
      'वेब खोज, AI छवि निर्माण और मीडिया विश्लेषण Zano क्लाउड से होते हैं और क्रेडिट खर्च करते हैं; बंद करने पर छवि टूल अनुपलब्ध होंगे और खोज मुफ्त स्रोतों का उपयोग करेगी।',
    setGithub: 'ओपन सोर्स',
    starOnGitHub: 'GitHub पर स्टार दें',
    starPromptTitle: 'Zanostack पसंद आ रहा है?',
    starPromptTitleN: 'आपने Zanostack में {n} दस्तावेज़ खोले हैं',
    starPromptBody:
      'Zanostack मुफ़्त और ओपन सोर्स है। GitHub पर एक स्टार टीम का सबसे अच्छा समर्थन है।',
    starPromptGo: 'स्टार दें',
    starPromptDone: 'पहले ही दे दिया',
    starPromptLater: 'बाद में',
    onbStarHint: 'अगर आपको Zanostack पसंद है, तो हमें GitHub पर स्टार दें।',
    setEmail: 'ईमेल',
    ...
    newTab: 'नया टैब',
    // First-run onboarding
    onbTitle1: 'Zanostack में आपका स्वागत है',
    ...
    onbBody2:
      'Zanostack अभी अल्फ़ा में है। Zanostack पर ग्रुप चैट से जुड़ें, फ़ीडबैक साझा करें और आगे की दिशा तय करने में मदद करें।',
    onbCredits: 'सक्रिय योगदानकर्ताओं के लिए **1,000+ Zano क्रेडिट**',
    onbJoinCommunity: 'Zanostack से जुड़ें',
    onbSkip: 'छोड़ें',
    onbNext: 'आगे',
    onbStart: 'शुरू करें',
    ...
    onbNote3: 'AI सुविधाएँ Zano क्रेडिट खर्च कर सकती हैं।',
    onbBack: 'वापस',
  },
  'zh-TW': {
    navRecent: '最近',
    navStarred: '收藏',
    navCloud: 'Zano Projects',
    cloudSubtitle: '在網頁端用 Zano AI 建立的專案。編輯在瀏覽器中繼續——點擊任意專案即可開啟。',
    ...
    cloudSortOldest: '最早',
    cloudRefresh: '重新整理',
    cloudLoginHint: '登入 Zano 帳號，查看你在網頁端建立的專案。',
    cloudEmpty: '還沒有網頁端專案。',
    ...
    account: '帳號',
    login: '登入',
    loginZano: '登入 Zano 帳號',
    loggedIn: '已登入',
    loggedInZano: '已登入 Zano',
    ...
    loginCopyUrl: '複製登入連結',
    loginCopied: '已複製',
    loginNetworkError: '無法連線至 Zano，請檢查網路或代理設定',
    ...
    setAiZanoHint: '使用 Zano 帳號登入，無需 API key。',
    setAiByokNote: '對話使用你自己的 key；網頁搜尋、生圖等雲端工具仍需登入 Zano。',
    setAiSave: '儲存',
    setAiSaved: '已儲存',
    setAiTest: '測試連線',
    setAiTesting: '測試中…',
    setAiTestOk: '連線成功',
    setAiTestFail: '連線失敗',
    setAiGskTools: 'Zano 雲端工具',
    setAiGskToolsDesc:
      '網頁搜尋、AI 生圖、媒體分析經 Zano 雲端並消耗點數；關閉後生圖與媒體分析不可用，搜尋改用免費來源。',
    setGithub: '開源專案',
    starOnGitHub: '到 GitHub 給我們一顆星',
    starPromptTitle: '喜歡 Zanostack 嗎？',
    starPromptTitleN: '你已經用 Zanostack 開啟了 {n} 個文件',
    starPromptBody: 'Zanostack 是免費的開源軟體。到 GitHub 給我們一顆星，是對團隊最好的支持。',
    starPromptGo: '去給星星',
    starPromptDone: '已經給過了',
    starPromptLater: '以後再說',
    onbStarHint: '如果你喜歡 Zanostack，歡迎到 GitHub 給我們一顆星。',
    setEmail: '電子郵件',
    setNotLoggedIn: '未登入',
    setViewUsage: '查看用量',
    setChange: '變更',
    ...
    newTab: '新分頁',
    // First-run onboarding
    onbTitle1: '歡迎使用 Zanostack',
    onbSubtitle1: '第一個開源的 AI 原生 Office 套件',
    onbBody1: '建立文件、製作試算表、產生簡報、審閱 PDF。AI 深度融入每個環節。',
    onbTitle2: '這只是一個開始',
    onbBody2: 'Zanostack 目前仍在 alpha 階段。歡迎加入 Zanostack 群聊，分享回饋，一起打造它的未來。',
    onbCredits: '活躍貢獻者可獲得 **1,000+ Zano 點數**',
    onbJoinCommunity: '加入 Zanostack',
    onbSkip: '略過',
    onbNext: '下一步',
    onbStart: '開始使用',
