...
export const strings = {
  zh: {
    ...
    bizBooks: '账本',
    bizCrmHint: '销售管线',
    bizTendersHint: '投标与 RFP',
    bizBooksHint: '财务与开票',
    appNavNewDoc: '新建文档',
    appNavNewSheet: '新建表格',
    appNavNewSlide: '新建演示',
    appNavNewPdf: '新建 PDF',
    appNavNewMd: '新建 Markdown',
    appNavNewHtml: '新建网页',
    ...
    onbTitle2: '这只是一个开始',
    onbBody2:
      'Zanostack 目前处于 alpha 阶段。欢迎加入 Zanostack 群聊，分享反馈，一起塑造它的未来。',
    onbCredits: '活跃贡献者可获得 **1,000+ Genspark 积分**',
    onbJoinGenTeam: '加入 Zanostack',
    onbSkip: '跳过',
    onbNext: '下一步',
    onbStart: '开始使用',
  ...
  en: {
    ...
    bizTenders: 'Tenders',
    bizBooks: 'Books',
    bizCrmHint: 'Sales pipeline',
    bizTendersHint: 'Bids & RFP',
    bizBooksHint: 'Finance & invoicing',
    appNavNewDoc: 'New document',
    appNavNewSheet: 'New spreadsheet',
    appNavNewSlide: 'New presentation',
    appNavNewPdf: 'New PDF',
    appNavNewMd: 'New markdown',
    appNavNewHtml: 'New web page',
    navCloud: 'Genspark Projects',
    cloudSubtitle:
  ...
  ja: {
    ...
    bizBooks: '帳簿',
    bizCrmHint: '営業パイプライン',
    bizTendersHint: '入札・RFP',
    bizBooksHint: '財務・請求書',
    appNavNewDoc: '新規文書',
    appNavNewSheet: '新規シート',
    appNavNewSlide: '新規プレゼン',
    appNavNewPdf: '新規 PDF',
    appNavNewMd: '新規 Markdown',
    appNavNewHtml: '新規ウェブページ',
    navCloud: 'Genspark Projects',
    cloudSubtitle:
  ...
  ko: {
    ...
    bizBooks: '장부',
    bizCrmHint: '영업 파이프라인',
    bizTendersHint: '입찰 및 RFP',
    bizBooksHint: '재무 및 청구서',
    appNavNewDoc: '새 문서',
    appNavNewSheet: '새 스프레드시트',
    appNavNewSlide: '새 프레젠테이션',
    appNavNewPdf: '새 PDF',
    appNavNewMd: '새 마크다운',
    appNavNewHtml: '새 웹페이지',
    navCloud: 'Genspark Projects',
    cloudSubtitle:
  ...
  fr: {
    ...
    bizTenders: 'Tenders',
    bizBooks: 'Books',
    bizCrmHint: 'Pipeline de vente',
    bizTendersHint: 'Appels d’offres & RFP',
    bizBooksHint: 'Finances & facturation',
    appNavNewDoc: 'Nouveau document',
    appNavNewSheet: 'Nouveau tableur',
    appNavNewSlide: 'Nouvelle présentation',
    appNavNewPdf: 'Nouveau PDF',
    appNavNewMd: 'Nouveau markdown',
    appNavNewHtml: 'Nouvelle page web',
    navCloud: 'Genspark Projects',
    cloudSubtitle:
    ...
    onbJoinGenTeam: 'Rejoindre Zanostack',
    onbSkip: 'Passer',
    onbNext: 'Suivant',
    onbStart: 'Commencer',
  ...
  de: {
    ...
    bizTenders: 'Tenders',
    bizBooks: 'Books',
    bizCrmHint: 'Vertriebspipeline',
    bizTendersHint: 'Ausschreibungen & RFP',
    bizBooksHint: 'Finanzen & Rechnungsstellung',
    appNavNewDoc: 'Neues Dokument',
    appNavNewSheet: 'Neue Tabelle',
    appNavNewSlide: 'Neue Präsentation',
    appNavNewPdf: 'Neues PDF',
    appNavNewMd: 'Neues Markdown',
    appNavNewHtml: 'Neue Webseite',
    navCloud: 'Genspark Projects',
    cloudSubtitle:
    ...
    onbJoinGenTeam: 'Zanostack beitreten',
  ...
  es: {
    ...
    bizTenders: 'Tenders',
    bizBooks: 'Books',
    bizCrmHint: 'Pipeline de ventas',
    bizTendersHint: 'Licitaciones y RFP',
    bizBooksHint: 'Finanzas y facturación',
    appNavNewDoc: 'Nuevo documento',
    appNavNewSheet: 'Nueva hoja de cálculo',
    appNavNewSlide: 'Nueva presentación',
    appNavNewPdf: 'Nuevo PDF',
    appNavNewMd: 'Nuevo markdown',
    appNavNewHtml: 'Nueva página web',
    navCloud: 'Genspark Projects',
    cloudSubtitle:
    ...
    onbJoinGenTeam: 'Unirse a Zanostack',
    onbSkip: 'Omitir',
    onbNext: 'Siguiente',
    onbStart: 'Empezar',
  ...
  th: {
    ...
    bizTenders: 'Tenders',
    bizBooks: 'Books',
    bizCrmHint: 'ไปป์ไลน์การขาย',
    bizTendersHint: 'การเสนอราคาและ RFP',
    bizBooksHint: 'การเงินและออกใบแจ้งหนี้',
    appNavNewDoc: 'เอกสารใหม่',
    appNavNewSheet: 'สเปรดชีตใหม่',
    appNavNewSlide: 'งานนำเสนอใหม่',
    appNavNewPdf: 'PDF ใหม่',
    appNavNewMd: 'Markdown ใหม่',
    appNavNewHtml: 'หน้าเว็บใหม่',
    navCloud: 'Genspark Projects',
    cloudSubtitle:
    ...
    onbJoinGenTeam: 'เข้าร่วม Zanostack',
    onbSkip: 'ข้าม',
    onbNext: 'ถัดไป',
  ...
  id: {
    ...
    bizTenders: 'Tenders',
    bizBooks: 'Books',
    bizCrmHint: 'Pipeline penjualan',
    bizTendersHint: 'Tender & RFP',
    bizBooksHint: 'Keuangan & faktur',
    appNavNewDoc: 'Dokumen baru',
    appNavNewSheet: 'Spreadsheet baru',
    appNavNewSlide: 'Presentasi baru',
    appNavNewPdf: 'PDF baru',
    appNavNewMd: 'Markdown baru',
    appNavNewHtml: 'Halaman web baru',
    navCloud: 'Genspark Projects',
    cloudSubtitle:
    ...
    onbJoinGenTeam: 'Gabung Zanostack',
    onbSkip: 'Lewati',
    onbNext: 'Berikutnya',
    onbStart: 'Mulai',
  ...
  ru: {
    ...
    bizTenders: 'Tenders',
    bizBooks: 'Books',
    bizCrmHint: 'Воронка продаж',
    bizTendersHint: 'Тендеры и RFP',
    bizBooksHint: 'Финансы и выставление счетов',
    appNavNewDoc: 'Новый документ',
    appNavNewSheet: 'Новая таблица',
    appNavNewSlide: 'Новая презентация',
    appNavNewPdf: 'Новый PDF',
    appNavNewMd: 'Новый Markdown',
    appNavNewHtml: 'Новая веб-страница',
    navCloud: 'Genspark Projects',
    cloudSubtitle:
    ...
    onbJoinGenTeam: 'Присоединиться к Zanostack',
    onbSkip: 'Пропустить',
    onbNext: 'Далее',
    onbStart: 'Начать',
  ...
  ar: {
    ...
    bizTenders: 'Tenders',
    bizBooks: 'Books',
    bizCrmHint: 'مسار المبيعات',
    bizTendersHint: 'العطاءات وطلبات العروض RFP',
    bizBooksHint: 'المالية والفوترة',
    appNavNewDoc: 'مستند جديد',
    appNavNewSheet: 'جدول بيانات جديد',
    appNavNewSlide: 'عرض تقديمي جديد',
    appNavNewPdf: 'ملف PDF جديد',
    appNavNewMd: 'ملف Markdown جديد',
    appNavNewHtml: 'صفحة ويب جديدة',
    navCloud: 'Genspark Projects',
    cloudSubtitle:
    ...
    onbJoinGenTeam: 'الانضمام إلى Zanostack',
    onbSkip: 'تخطي',
    onbNext: 'التالي',
    onbStart: 'ابدأ الآن',
  ...
  pt: {
    ...
    bizTenders: 'Tenders',
    bizBooks: 'Books',
    bizCrmHint: 'Pipeline de vendas',
    bizTendersHint: 'Licitações e RFP',
    bizBooksHint: 'Finanças e faturamento',
    appNavNewDoc: 'Novo documento',
    appNavNewSheet: 'Nova planilha',
    appNavNewSlide: 'Nova apresentação',
    appNavNewPdf: 'Novo PDF',
    appNavNewMd: 'Novo markdown',
    appNavNewHtml: 'Nova página web',
    navCloud: 'Genspark Projects',
    cloudSubtitle:
    ...
    onbJoinGenTeam: 'Entrar no Zanostack',
    onbSkip: 'Pular',
    onbNext: 'Avançar',
    onbStart: 'Começar',
    onbStepAria: 'Página {n} de {total}',
  ...
  it: {
    ...
    bizTenders: 'Tenders',
    bizBooks: 'Books',
    bizCrmHint: 'Pipeline di vendita',
    bizTendersHint: 'Gare d’appalto e RFP',
    bizBooksHint: 'Finanze e fatturazione',
    appNavNewDoc: 'Nuovo documento',
    appNavNewSheet: 'Nuovo foglio di calcolo',
    appNavNewSlide: 'Nuova presentazione',
    appNavNewPdf: 'Nuovo PDF',
    appNavNewMd: 'Nuovo markdown',
    appNavNewHtml: 'Nuova pagina web',
    navCloud: 'Genspark Projects',
    cloudSubtitle:
    ...
    onbJoinGenTeam: 'Unisciti a Zanostack',
    onbSkip: 'Salta',
    onbNext: 'Avanti',
    onbStart: 'Inizia',
  ...
  pl: {
    ...
    bizTenders: 'Tenders',
    bizBooks: 'Books',
    bizCrmHint: 'Lejek sprzedażowy',
    bizTendersHint: 'Przetargi i RFP',
    bizBooksHint: 'Finanse i fakturowanie',
    appNavNewDoc: 'Nowy dokument',
    appNavNewSheet: 'Nowy arkusz kalkulacyjny',
    appNavNewSlide: 'Nowa prezentacja',
    appNavNewPdf: 'Nowy PDF',
    appNavNewMd: 'Nowy markdown',
    appNavNewHtml: 'Nowa strona internetowa',
    navCloud: 'Genspark Projects',
    cloudSubtitle:
    ...
    onbJoinGenTeam: 'Dołącz do Zanostack',
    onbSkip: 'Pomiń',
    onbNext: 'Dalej',
    onbStart: 'Rozpocznij',
  ...
  cs: {
    ...
    bizTenders: 'Tenders',
    bizBooks: 'Books',
    bizCrmHint: 'Prodejní pipeline',
    bizTendersHint: 'Veřejné zakázky a RFP',
    bizBooksHint: 'Finance a fakturace',
    appNavNewDoc: 'Nový dokument',
    appNavNewSheet: 'Nová tabulka',
    appNavNewSlide: 'Nová prezentace',
    appNavNewPdf: 'Nové PDF',
    appNavNewMd: 'Nový markdown',
    appNavNewHtml: 'Nová webová stránka',
    navCloud: 'Genspark Projects',
    cloudSubtitle:
    ...
    starPromptTitle: 'Líbí se vám Zanostack?',
    starPromptTitleN: 'V Zanostack jste otevřeli už {n} dokumentů',
    starPromptBody:
      'Zanostack je zdarma a open source. Hvězdička na GitHubu je nejlepší způsob, jak tým podpořit.',
    starPromptGo: 'Dát hvězdičku na GitHubu',
    starPromptDone: 'Hvězdička už udělena',
    starPromptLater: 'Možná později',
    onbStarHint: 'Pokud se vám Zanostack líbí, dejte nám hvězdičku na GitHubu.',
    setEmail: 'E-mail',
  ...
  nl: {
    ...
    bizTenders: 'Tenders',
    bizBooks: 'Books',
    bizCrmHint: 'Verkooppijplijn',
    bizTendersHint: 'Tenders & RFP',
    bizBooksHint: 'Financiën en facturatie',
    appNavNewDoc: 'Nieuw document',
    appNavNewSheet: 'Nieuw spreadsheet',
    appNavNewSlide: 'Nieuwe presentatie',
    appNavNewPdf: 'Nieuwe PDF',
    appNavNewMd: 'Nieuwe Markdown',
    appNavNewHtml: 'Nieuwe webpagina',
    navCloud: 'Genspark Projects',
    cloudSubtitle:
    ...
    onbJoinGenTeam: 'Word lid van Zanostack',
    onbSkip: 'Overslaan',
    onbNext: 'Volgende',
  ...
  ms: {
    ...
    bizTenders: 'Tenders',
    bizBooks: 'Books',
    bizCrmHint: 'Saluran jualan',
    bizTendersHint: 'Tender & RFP',
    bizBooksHint: 'Kewangan & penginvoisan',
    appNavNewDoc: 'Dokumen baharu',
    appNavNewSheet: 'Hamparan baharu',
    appNavNewSlide: 'Pembentangan baharu',
    appNavNewPdf: 'PDF baharu',
    appNavNewMd: 'Markdown baharu',
    appNavNewHtml: 'Laman web baharu',
    navCloud: 'Genspark Projects',
    cloudSubtitle:
    ...
    onbJoinGenTeam: 'Sertai Zanostack',
    onbSkip: 'Langkau',
    onbNext: 'Seterusnya',
    onbStart: 'Mula',
  ...
  he: {
    ...
    bizTenders: 'Tenders',
    bizBooks: 'Books',
    bizCrmHint: 'צינור המכירות',
    bizTendersHint: 'מכרזים ו-RFP',
    bizBooksHint: 'כספים וחשבוניות',
    appNavNewDoc: 'מסמך חדש',
    appNavNewSheet: 'גיליון אלקטרוני חדש',
    appNavNewSlide: 'מצגת חדשה',
    appNavNewPdf: 'PDF חדש',
    appNavNewMd: 'Markdown חדש',
    appNavNewHtml: 'דף אינטרנט חדש',
    navCloud: 'Genspark Projects',
    cloudSubtitle:
    ...
    onbJoinGenTeam: 'הצטרפו ל-Zanostack',
    onbSkip: 'דילוג',
    onbNext: 'הבא',
    onbStart: 'להתחיל',
  ...
  hi: {
    ...
    bizTenders: 'Tenders',
    bizBooks: 'Books',
    bizCrmHint: 'बिक्री पाइपलाइन',
    bizTendersHint: 'निविदा और RFP',
    bizBooksHint: 'वित्त और इनवॉइसिंग',
    appNavNewDoc: 'नया दस्तावेज़',
    appNavNewSheet: 'नई स्प्रेडशीट',
    appNavNewSlide: 'नई प्रस्तुति',
    appNavNewPdf: 'नया PDF',
    appNavNewMd: 'नया मार्कडाउन',
    appNavNewHtml: 'नया वेब पेज',
    navCloud: 'Genspark Projects',
    cloudSubtitle:
    ...
    onbJoinGenTeam: 'Zanostack से जुड़ें',
    onbSkip: 'छोड़ें',
    onbNext: 'आगे',
    onbStart: 'शुरू करें',
  ...
  'zh-TW': {
    ...
    bizBooks: '帳簿',
    bizCrmHint: '銷售管線',
    bizTendersHint: '投標與 RFP',
    bizBooksHint: '財務與開票',
    appNavNewDoc: '新建文件',
    appNavNewSheet: '新建表格',
    appNavNewSlide: '新增簡報',
    appNavNewPdf: '新增 PDF',
    appNavNewMd: '新增 Markdown',
    appNavNewHtml: '新增網頁',
    navCloud: 'Genspark Projects',
    ...
    onbTitle2: '這只是一個開始',
    onbBody2:
      'Zanostack 目前仍在 alpha 階段。歡迎加入 Zanostack 群聊，分享回饋，一起打造它的未來。',
