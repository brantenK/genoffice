...
export const strings = {
  zh: {
    ...
    starPromptTitle: '喜欢 ExampleOffice 吗？',
    starPromptTitleN: '你已经用 ExampleOffice 打开了 {n} 个文档',
    starPromptBody: 'ExampleOffice 是免费开源软件。到 GitHub 给我们一个 Star，是对团队最好的支持。',
    starPromptGo: '去点 Star',
    starPromptDone: '已经点过了',
    starPromptLater: '以后再说',
    onbStarHint: '如果你喜欢 ExampleOffice，欢迎到 GitHub 给我们一个 Star。',
    setEmail: '邮箱',
    setNotLoggedIn: '未登录',
    setViewUsage: '查看用量',
    setChange: '更改',
    ...
    onbTitle1: '欢迎使用 ExampleOffice',
    onbSubtitle1: '第一个开源的 AI 原生 Office 套件',
    onbBody1: '创建文档、制作表格、生成演示、审阅 PDF。AI 深度融入每个环节。',
    onbTitle2: '这只是一个开始',
    onbBody2: 'ExampleOffice 目前处于 alpha 阶段。欢迎加入 ExampleOffice 群聊，分享反馈，一起塑造它的未来。',
    onbCredits: '活跃贡献者可获得 **1,000+ Genspark 积分**',
    onbJoinExampleOffice: '加入 ExampleOffice',
    onbSkip: '跳过',
    onbNext: '下一步',
    onbStart: '开始使用',
  ...
  en: {
    ...
    starPromptTitle: 'Enjoying ExampleOffice?',
    starPromptTitleN: "You've opened {n} documents with ExampleOffice",
    starPromptBody:
      'ExampleOffice is free and open source. A star on GitHub is the best way to support the team.',
    starPromptGo: 'Star on GitHub',
    starPromptDone: 'Already starred',
    starPromptLater: 'Maybe later',
    onbStarHint: 'If you like ExampleOffice, give us a star on GitHub.',
    setEmail: 'Email',
    ...
    newTab: 'New tab',
    // First-run onboarding
    onbTitle1: 'Welcome to ExampleOffice',
    ...
    onbBody2:
      'ExampleOffice is still in alpha. Join the group chat on ExampleOffice to share feedback and help shape what comes next.',
    onbCredits: 'Active contributors get **1,000+ Genspark credits**',
    onbJoinExampleOffice: 'Join ExampleOffice',
    onbSkip: 'Skip',
    onbNext: 'Next',
  ...
  ja: {
    ...
    starPromptTitle: 'ExampleOffice はいかがですか？',
    starPromptTitleN: 'ExampleOffice で {n} 件のドキュメントを開きました',
    starPromptBody:
      'ExampleOffice は無料のオープンソースソフトウェアです。GitHub のスターがチームへの何よりの応援になります。',
    starPromptGo: 'スターを付ける',
    starPromptDone: 'スター済み',
    starPromptLater: 'あとで',
    onbStarHint: 'ExampleOffice が気に入ったら、GitHub でスターをお願いします。',
    setEmail: 'メール',
  ...
  ko: {
    ...
    starPromptTitle: 'ExampleOffice가 마음에 드시나요?',
    starPromptTitleN: 'ExampleOffice로 문서를 {n}개 열어보셨네요',
    starPromptBody:
      'ExampleOffice는 무료 오픈 소스 소프트웨어입니다. GitHub 스타 하나가 팀에게 가장 큰 응원이 됩니다.',
    starPromptGo: '스타 누르기',
    starPromptDone: '이미 눌렀어요',
    starPromptLater: '나중에',
    onbStarHint: 'ExampleOffice가 마음에 들면 GitHub에서 스타를 눌러 주세요.',
    setEmail: '이메일',
    ...
    newTab: '새 탭',
    // First-run onboarding
    onbTitle1: 'ExampleOffice에 오신 것을 환영합니다',
    onbSubtitle1: '최초의 오픈소스 AI 네이티브 오피스 제품군',
    onbBody1:
      '문서 작성, 스프레드시트 제작, 프레젠테이션 생성, PDF 검토. 모든 단계에 AI가 녹아 있습니다.',
    onbTitle2: '이제 시작일 뿐입니다',
    onbBody2:
      'ExampleOffice는 아직 알파 단계입니다. ExampleOffice 그룹 채팅에 참여해 피드백을 공유하고 앞으로의 방향을 함께 만들어 가세요.',
    onbCredits: '활발한 기여자를 위한 혜택 **1,000+ Genspark 크레딧**',
    onbJoinExampleOffice: 'ExampleOffice 참여하기',
    onbSkip: '건너뛰기',
    onbNext: '다음',
    onbStart: '시작하기',
  ...
  fr: {
    ...
    starPromptTitle: 'ExampleOffice vous plaît ?',
    starPromptTitleN: 'Vous avez ouvert {n} documents avec ExampleOffice',
    starPromptBody:
      'ExampleOffice est gratuit et open source. Une étoile sur GitHub est le meilleur moyen de soutenir l’équipe.',
    starPromptGo: 'Mettre une étoile',
    starPromptDone: 'Déjà fait',
    starPromptLater: 'Plus tard',
    onbStarHint: 'Si ExampleOffice vous plaît, mettez-nous une étoile sur GitHub.',
    setEmail: 'E-mail',
    ...
    // First-run onboarding
    onbTitle1: 'Bienvenue dans ExampleOffice',
    ...
    onbBody2:
      'ExampleOffice est encore en alpha. Rejoignez la discussion de groupe sur ExampleOffice pour partager vos retours et façonner la suite.',
    onbCredits: 'Les contributeurs actifs reçoivent **1 000+ crédits Genspark**',
    onbJoinExampleOffice: 'Rejoindre ExampleOffice',
    onbSkip: 'Passer',
    onbNext: 'Suivant',
    onbStart: 'Commencer',
  ...
  de: {
    ...
    starPromptTitle: 'Gefällt Ihnen ExampleOffice?',
    starPromptTitleN: 'Sie haben {n} Dokumente mit ExampleOffice geöffnet',
    starPromptBody:
      'ExampleOffice ist kostenlos und Open Source. Ein Stern auf GitHub ist die beste Unterstützung für das Team.',
    starPromptGo: 'Stern geben',
    starPromptDone: 'Schon erledigt',
    starPromptLater: 'Später',
    onbStarHint: 'Wenn Ihnen ExampleOffice gefällt, geben Sie uns einen Stern auf GitHub.',
    setEmail: 'E-Mail',
    ...
    newTab: 'Neuer Tab',
    // First-run onboarding
    onbTitle1: 'Willkommen bei ExampleOffice',
    ...
    onbBody2:
      'ExampleOffice ist noch in der Alpha-Phase. Treten Sie dem Gruppenchat auf ExampleOffice bei, um Feedback zu teilen und die Zukunft mitzugestalten.',
    onbCredits: 'Aktive Mitwirkende erhalten **1.000+ Genspark-Guthaben**',
    onbJoinExampleOffice: 'ExampleOffice beitreten',
  ...
  es: {
    ...
    starPromptTitle: '¿Te gusta ExampleOffice?',
    starPromptTitleN: 'Has abierto {n} documentos con ExampleOffice',
    starPromptBody:
      'ExampleOffice es gratuito y de código abierto. Una estrella en GitHub es la mejor forma de apoyar al equipo.',
    starPromptGo: 'Dar una estrella',
    starPromptDone: 'Ya la di',
    starPromptLater: 'Más tarde',
    onbStarHint: 'Si te gusta ExampleOffice, danos una estrella en GitHub.',
    ...
    // First-run onboarding
    onbTitle1: 'Bienvenido a ExampleOffice',
    ...
    onbBody2:
      'ExampleOffice aún está en alfa. Únete al chat grupal en ExampleOffice para compartir comentarios y ayudar a dar forma a lo que viene.',
    onbCredits: 'Los colaboradores activos reciben **1.000+ créditos de Genspark**',
    onbJoinExampleOffice: 'Unirse a ExampleOffice',
    onbSkip: 'Omitir',
    onbNext: 'Siguiente',
    onbStart: 'Empezar',
  ...
  th: {
    ...
    starPromptTitle: 'ชอบ ExampleOffice ไหม?',
    starPromptTitleN: 'คุณเปิดเอกสารด้วย ExampleOffice ไปแล้ว {n} ไฟล์',
    starPromptBody:
      'ExampleOffice ฟรีและเป็นโอเพนซอร์ส การกดดาวบน GitHub คือกำลังใจที่ดีที่สุดสำหรับทีม',
    starPromptGo: 'กดดาวเลย',
    starPromptDone: 'กดแล้ว',
    starPromptLater: 'ไว้ทีหลัง',
    onbStarHint: 'ถ้าชอบ ExampleOffice ฝากกดดาวให้เราบน GitHub ด้วยนะ',
    setEmail: 'อีเมล',
    ...
    newTab: 'แท็บใหม่',
    // First-run onboarding
    onbTitle1: 'ยินดีต้อนรับสู่ ExampleOffice',
    ...
    onbBody2:
      'ExampleOffice ยังอยู่ในช่วงอัลฟ่า เข้าร่วมแชทกลุ่มบน ExampleOffice เพื่อแบ่งปันความคิดเห็นและร่วมกำหนดทิศทางต่อไป',
    onbCredits: 'ผู้มีส่วนร่วมอย่างต่อเนื่องจะได้รับ **เครดิต Genspark กว่า 1,000**',
    onbJoinExampleOffice: 'เข้าร่วม ExampleOffice',
    onbSkip: 'ข้าม',
    onbNext: 'ถัดไป',
  ...
  id: {
    ...
    starPromptTitle: 'Suka ExampleOffice?',
    starPromptTitleN: 'Anda telah membuka {n} dokumen dengan ExampleOffice',
    starPromptBody:
      'ExampleOffice gratis dan open source. Bintang di GitHub adalah dukungan terbaik untuk tim kami.',
    starPromptGo: 'Beri Bintang',
    starPromptDone: 'Sudah',
    starPromptLater: 'Nanti saja',
    onbStarHint: 'Jika Anda menyukai ExampleOffice, beri kami bintang di GitHub.',
    setEmail: 'Email',
    ...
    newTab: 'Tab baru',
    // First-run onboarding
    onbTitle1: 'Selamat datang di ExampleOffice',
    ...
    onbBody2:
      'ExampleOffice masih dalam tahap alpha. Gabung obrolan grup di ExampleOffice untuk berbagi masukan dan ikut menentukan arah ke depan.',
    onbCredits: 'Kontributor aktif mendapat **1.000+ kredit Genspark**',
    onbJoinExampleOffice: 'Gabung ExampleOffice',
    onbSkip: 'Lewati',
    onbNext: 'Berikutnya',
    onbStart: 'Mulai',
  ...
  ru: {
    ...
    starPromptTitle: 'Нравится ExampleOffice?',
    starPromptTitleN: 'Вы уже открыли {n} документов в ExampleOffice',
    starPromptBody:
      'ExampleOffice — бесплатное ПО с открытым кодом. Звезда на GitHub — лучшая поддержка для команды.',
    starPromptGo: 'Поставить звезду',
    starPromptDone: 'Уже поставлена',
    starPromptLater: 'Позже',
    onbStarHint: 'Если вам нравится ExampleOffice, поставьте нам звезду на GitHub.',
    setEmail: 'Эл. почта',
    ...
    // First-run onboarding
    onbTitle1: 'Добро пожаловать в ExampleOffice',
    ...
    onbBody2:
      'ExampleOffice пока в альфа-версии. Присоединяйтесь к групповому чату в ExampleOffice, чтобы делиться отзывами и влиять на дальнейшее развитие.',
    onbCredits: 'Активные участники получают **1000+ кредитов Genspark**',
    onbJoinExampleOffice: 'Присоединиться к ExampleOffice',
    onbSkip: 'Пропустить',
    onbNext: 'Далее',
    onbStart: 'Начать',
  ...
  ar: {
    ...
    starPromptTitle: 'هل أعجبك ExampleOffice؟',
    starPromptTitleN: 'لقد فتحت {n} من المستندات في ExampleOffice',
    starPromptBody: 'ExampleOffice مجاني ومفتوح المصدر. نجمة على GitHub هي أفضل دعم للفريق.',
    starPromptGo: 'ضع نجمة',
    starPromptDone: 'وضعتها بالفعل',
    starPromptLater: 'لاحقًا',
    onbStarHint: 'إذا أعجبك ExampleOffice، ضع لنا نجمة على GitHub.',
    ...
    // First-run onboarding
    onbTitle1: 'مرحبًا بك في ExampleOffice',
    ...
    onbBody2:
      'لا يزال ExampleOffice في مرحلة ألفا. انضم إلى الدردشة الجماعية على ExampleOffice لمشاركة ملاحظاتك والمساهمة في تشكيل المستقبل.',
    onbCredits: 'يحصل المساهمون النشطون على **+1,000 من أرصدة Genspark**',
    onbJoinExampleOffice: 'الانضمام إلى ExampleOffice',
    onbSkip: 'تخطي',
    onbNext: 'التالي',
    onbStart: 'ابدأ الآن',
  ...
  pt: {
    ...
    starPromptTitle: 'Gostando do ExampleOffice?',
    starPromptTitleN: 'Você já abriu {n} documentos com o ExampleOffice',
    starPromptBody:
      'O ExampleOffice é gratuito e de código aberto. Uma estrela no GitHub é a melhor forma de apoiar a equipe.',
    starPromptGo: 'Dar uma estrela',
    starPromptDone: 'Já dei',
    starPromptLater: 'Mais tarde',
    onbStarHint: 'Se você gosta do ExampleOffice, deixe uma estrela no GitHub.',
    setEmail: 'E-mail',
    ...
    newTab: 'Nova guia',
    // First-run onboarding
    onbTitle1: 'Bem-vindo ao ExampleOffice',
    ...
    onbBody2:
      'O ExampleOffice ainda está em alfa. Entre no chat em grupo no ExampleOffice para compartilhar feedback e ajudar a moldar o que vem a seguir.',
    onbCredits: 'Contribuidores ativos recebem **1.000+ créditos Genspark**',
    onbJoinExampleOffice: 'Entrar no ExampleOffice',
    onbSkip: 'Pular',
    onbNext: 'Avançar',
    onbStart: 'Começar',
    onbStepAria: 'Página {n} de {total}',
  ...
  it: {
    ...
    starPromptTitle: 'Ti piace ExampleOffice?',
    starPromptTitleN: 'Hai aperto {n} documenti con ExampleOffice',
    starPromptBody:
      'ExampleOffice è gratuito e open source. Una stella su GitHub è il modo migliore per sostenere il team.',
    starPromptGo: 'Metti una stella',
    starPromptDone: 'Già fatto',
    starPromptLater: 'Più tardi',
    onbStarHint: 'Se ti piace ExampleOffice, lasciaci una stella su GitHub.',
    setEmail: 'Email',
    ...
    newTab: 'Nuova scheda',
    // First-run onboarding
    onbTitle1: 'Benvenuto in ExampleOffice',
    ...
    onbBody2:
      'ExampleOffice è ancora in alpha. Unisciti alla chat di gruppo su ExampleOffice per condividere feedback e contribuire a plasmare il futuro.',
    onbCredits: 'I collaboratori attivi ricevono **1.000+ crediti Genspark**',
    onbJoinExampleOffice: 'Unisciti a ExampleOffice',
    onbSkip: 'Salta',
    onbNext: 'Avanti',
    onbStart: 'Inizia',
  ...
  pl: {
    ...
    starPromptTitle: 'Podoba Ci się ExampleOffice?',
    starPromptTitleN: 'Otwarto już {n} dokumentów w ExampleOffice',
    starPromptBody:
      'ExampleOffice jest darmowy i open source. Gwiazdka na GitHubie to najlepsze wsparcie dla zespołu.',
    starPromptGo: 'Daj gwiazdkę',
    starPromptDone: 'Już zrobione',
    starPromptLater: 'Później',
    onbStarHint: 'Jeśli podoba Ci się ExampleOffice, zostaw nam gwiazdkę na GitHubie.',
    setEmail: 'E-mail',
    ...
    newTab: 'Nowa karta',
    // First-run onboarding
    onbTitle1: 'Witamy w ExampleOffice',
    ...
    onbBody2:
      'ExampleOffice jest wciąż w fazie alfa. Dołącz do czatu grupowego na ExampleOffice, aby dzielić się opiniami i współtworzyć jego przyszłość.',
    onbCredits: 'Aktywni współtwórcy otrzymują **1000+ kredytów Genspark**',
    onbJoinExampleOffice: 'Dołącz do ExampleOffice',
    onbSkip: 'Pomiń',
    onbNext: 'Dalej',
    onbStart: 'Rozpocznij',
  ...
  nl: {
    ...
    starPromptTitle: 'Bevalt ExampleOffice?',
    starPromptTitleN: 'Je hebt al {n} documenten geopend met ExampleOffice',
    starPromptBody:
      'ExampleOffice is gratis en open source. Een ster op GitHub is de beste steun voor het team.',
    starPromptGo: 'Geef een ster',
    starPromptDone: 'Al gedaan',
    starPromptLater: 'Later',
    onbStarHint: 'Als ExampleOffice je bevalt, geef ons dan een ster op GitHub.',
    setEmail: 'E-mail',
    ...
    // First-run onboarding
    onbTitle1: 'Welkom bij ExampleOffice',
    ...
    onbBody2:
      'ExampleOffice is nog in alfa. Doe mee aan de groepschat op ExampleOffice om feedback te delen en mee te bepalen wat er komt.',
    onbCredits: 'Actieve bijdragers krijgen **1.000+ Genspark-credits**',
    onbJoinExampleOffice: 'Word lid van ExampleOffice',
    onbSkip: 'Overslaan',
    onbNext: 'Volgende',
  ...
  ms: {
    ...
    starPromptTitleN: 'Anda telah membuka {n} dokumen dengan ExampleOffice',
    starPromptBody:
      'ExampleOffice percuma dan sumber terbuka. Bintang di GitHub ialah sokongan terbaik untuk pasukan kami.',
    starPromptGo: 'Beri Bintang',
    starPromptDone: 'Sudah',
    starPromptLater: 'Kemudian',
    onbStarHint: 'Jika anda suka ExampleOffice, beri kami bintang di GitHub.',
    setEmail: 'E-mel',
    ...
    newTab: 'Tab baharu',
    // First-run onboarding
    onbTitle1: 'Selamat datang ke ExampleOffice',
    ...
    onbTitle2: 'Ini baru permulaan',
    onbBody2:
      'ExampleOffice masih dalam peringkat alfa. Sertai sembang kumpulan di ExampleOffice untuk berkongsi maklum balas dan membentuk masa depannya.',
    onbCredits: 'Penyumbang aktif menerima **1,000+ kredit Genspark**',
    onbJoinExampleOffice: 'Sertai ExampleOffice',
    onbSkip: 'Langkau',
    onbNext: 'Seterusnya',
    onbStart: 'Mula',
  ...
  he: {
    ...
    starPromptTitle: 'נהנים מ-ExampleOffice?',
    starPromptTitleN: 'פתחת {n} מסמכים עם ExampleOffice',
    starPromptBody: 'ExampleOffice חינמי ובקוד פתוח. כוכב ב-GitHub הוא התמיכה הטובה ביותר בצוות.',
    starPromptGo: 'לתת כוכב',
    starPromptDone: 'כבר נתתי',
    starPromptLater: 'אחר כך',
    onbStarHint: 'אם ExampleOffice מוצא חן בעיניכם, תנו לנו כוכב ב-GitHub.',
    setEmail: 'אימייל',
    ...
    // First-run onboarding
    onbTitle1: 'ברוכים הבאים ל-ExampleOffice',
    ...
    onbBody2:
      'ExampleOffice עדיין בגרסת אלפא. הצטרפו לצ׳אט הקבוצתי ב-ExampleOffice כדי לשתף משוב ולעזור לעצב את ההמשך.',
    onbCredits: 'תורמים פעילים מקבלים **1,000+ נקודות Genspark**',
    onbJoinExampleOffice: 'הצטרפו ל-ExampleOffice',
    onbSkip: 'דילוג',
    onbNext: 'הבא',
    onbStart: 'להתחיל',
  ...
  hi: {
    ...
    starPromptTitle: 'ExampleOffice पसंद आ रहा है?',
    starPromptTitleN: 'आपने ExampleOffice में {n} दस्तावेज़ खोले हैं',
    starPromptBody:
      'ExampleOffice मुफ़्त और ओपन सोर्स है। GitHub पर एक स्टार टीम का सबसे अच्छा समर्थन है।',
    starPromptGo: 'स्टार दें',
    starPromptDone: 'पहले ही दे दिया',
    starPromptLater: 'बाद में',
    onbStarHint: 'अगर आपको ExampleOffice पसंद है, तो हमें GitHub पर स्टार दें।',
    setEmail: 'ईमेल',
    ...
    newTab: 'नया टैब',
    // First-run onboarding
    onbTitle1: 'ExampleOffice में आपका स्वागत है',
    ...
    onbBody2:
      'ExampleOffice अभी अल्फ़ा में है। ExampleOffice पर ग्रुप चैट से जुड़ें, फ़ीडबैक साझा करें और आगे की दिशा तय करने में मदद करें।',
    onbCredits: 'सक्रिय योगदानकर्ताओं के लिए **1,000+ Genspark क्रेडिट**',
    onbJoinExampleOffice: 'ExampleOffice से जुड़ें',
    onbSkip: 'छोड़ें',
    onbNext: 'आगे',
    onbStart: 'शुरू करें',
  ...
  'zh-TW': {
    ...
    starPromptTitle: '喜歡 ExampleOffice 嗎？',
    starPromptTitleN: '你已經用 ExampleOffice 開啟了 {n} 個文件',
    starPromptBody: 'ExampleOffice 是免費的開源軟體。到 GitHub 給我們一顆星，是對團隊最好的支持。',
    starPromptGo: '去給星星',
    starPromptDone: '已經給過了',
    starPromptLater: '以後再說',
    onbStarHint: '如果你喜歡 ExampleOffice，歡迎到 GitHub 給我們一顆星。',
    setEmail: '電子郵件',
    setNotLoggedIn: '未登入',
    setViewUsage: '查看用量',
    setChange: '變更',
    ...
    newTab: '新分頁',
    // First-run onboarding
    onbTitle1: '歡迎使用 ExampleOffice',
    onbSubtitle1: '第一個開源的 AI 原生 Office 套件',
    onbBody1: '建立文件、製作試算表、產生簡報、審閱 PDF。AI 深度融入每個環節。',
    onbTitle2: '這只是一個開始',
    onbBody2: 'ExampleOffice 目前仍在 alpha 階段。歡迎加入 ExampleOffice 群聊，分享回饋，一起打造它的未來。',
