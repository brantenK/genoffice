...
export const strings = {
  zh: {
    ...
    starPromptTitle: '喜欢 Zano Office 吗？',
    starPromptTitleN: '你已经用 Zano Office 打开了 {n} 个文档',
    starPromptBody: 'Zano Office 是免费开源软件。到 GitHub 给我们一个 Star，是对团队最好的支持。',
    starPromptGo: '去点 Star',
    starPromptDone: '已经点过了',
    starPromptLater: '以后再说',
    onbStarHint: '如果你喜欢 Zano Office，欢迎到 GitHub 给我们一个 Star。',
    setEmail: '邮箱',
    setNotLoggedIn: '未登录',
    setViewUsage: '查看用量',
    setChange: '更改',
    ...
    onbTitle1: '欢迎使用 Zano Office',
    onbSubtitle1: '第一个开源的 AI 原生 Office 套件',
    onbBody1: '创建文档、制作表格、生成演示、审阅 PDF。AI 深度融入每个环节。',
    onbTitle2: '这只是一个开始',
    onbBody2: 'Zano Office 目前处于 alpha 阶段。欢迎加入 Zano Office 群聊，分享反馈，一起塑造它的未来。',
    onbCredits: '活跃贡献者可获得 **1,000+ Genspark 积分**',
    onbJoinCommunity: '加入 Zano Office',
    onbSkip: '跳过',
    onbNext: '下一步',
    onbStart: '开始使用',
  ...
  en: {
    ...
    starPromptTitle: 'Enjoying Zano Office?',
    starPromptTitleN: "You've opened {n} documents with Zano Office",
    starPromptBody:
      'Zano Office is free and open source. A star on GitHub is the best way to support the team.',
    starPromptGo: 'Star on GitHub',
    starPromptDone: 'Already starred',
    starPromptLater: 'Maybe later',
    onbStarHint: 'If you like Zano Office, give us a star on GitHub.',
    setEmail: 'Email',
    ...
    newTab: 'New tab',
    // First-run onboarding
    onbTitle1: 'Welcome to Zano Office',
    ...
    onbBody2:
      'Zano Office is still in alpha. Join the group chat on Zano Office to share feedback and help shape what comes next.',
    onbCredits: 'Active contributors get **1,000+ Genspark credits**',
    onbJoinCommunity: 'Join Zano Office',
    onbSkip: 'Skip',
    onbNext: 'Next',
  ...
  ja: {
    ...
    starPromptTitle: 'Zano Office はいかがですか？',
    starPromptTitleN: 'Zano Office で {n} 件のドキュメントを開きました',
    starPromptBody:
      'Zano Office は無料のオープンソースソフトウェアです。GitHub のスターがチームへの何よりの応援になります。',
    starPromptGo: 'スターを付ける',
    starPromptDone: 'スター済み',
    starPromptLater: 'あとで',
    onbStarHint: 'Zano Office が気に入ったら、GitHub でスターをお願いします。',
    setEmail: 'メール',
  ...
  ko: {
    ...
    starPromptTitle: 'Zano Office가 마음에 드시나요?',
    starPromptTitleN: 'Zano Office로 문서를 {n}개 열어보셨네요',
    starPromptBody:
      'Zano Office는 무료 오픈 소스 소프트웨어입니다. GitHub 스타 하나가 팀에게 가장 큰 응원이 됩니다.',
    starPromptGo: '스타 누르기',
    starPromptDone: '이미 눌렀어요',
    starPromptLater: '나중에',
    onbStarHint: 'Zano Office가 마음에 들면 GitHub에서 스타를 눌러 주세요.',
    setEmail: '이메일',
  ...
  fr: {
    ...
    starPromptTitle: 'Zano Office vous plaît ?',
    starPromptTitleN: 'Vous avez ouvert {n} documents avec Zano Office',
    starPromptBody:
      'Zano Office est gratuit et open source. Une étoile sur GitHub est le meilleur moyen de soutenir l’équipe.',
    starPromptGo: 'Mettre une étoile',
    starPromptDone: 'Déjà fait',
    starPromptLater: 'Plus tard',
    onbStarHint: 'Si Zano Office vous plaît, mettez-nous une étoile sur GitHub.',
    setEmail: 'E-mail',
    ...
    // First-run onboarding
    onbTitle1: 'Bienvenue dans Zano Office',
    ...
    onbBody2:
      'Zano Office est encore en alpha. Rejoignez la discussion de groupe sur Zano Office pour partager vos retours et façonner la suite.',
    onbCredits: 'Les contributeurs actifs reçoivent **1 000+ crédits Genspark**',
    onbJoinCommunity: 'Rejoindre Zano Office',
    onbSkip: 'Passer',
    onbNext: 'Suivant',
    onbStart: 'Commencer',
  ...
  de: {
    ...
    starPromptTitle: 'Gefällt Ihnen Zano Office?',
    starPromptTitleN: 'Sie haben {n} Dokumente mit Zano Office geöffnet',
    starPromptBody:
      'Zano Office ist kostenlos und Open Source. Ein Stern auf GitHub ist die beste Unterstützung für das Team.',
    starPromptGo: 'Stern geben',
    starPromptDone: 'Schon erledigt',
    starPromptLater: 'Später',
    onbStarHint: 'Wenn Ihnen Zano Office gefällt, geben Sie uns einen Stern auf GitHub.',
    setEmail: 'E-Mail',
    ...
    newTab: 'Neuer Tab',
    // First-run onboarding
    onbTitle1: 'Willkommen bei Zano Office',
    ...
    onbBody2:
      'Zano Office ist noch in der Alpha-Phase. Treten Sie dem Gruppenchat auf Zano Office bei, um Feedback zu teilen und die Zukunft mitzugestalten.',
    onbCredits: 'Aktive Mitwirkende erhalten **1.000+ Genspark-Guthaben**',
    onbJoinCommunity: 'Zano Office beitreten',
  ...
  es: {
    ...
    starPromptTitle: '¿Te gusta Zano Office?',
    starPromptTitleN: 'Has abierto {n} documentos con Zano Office',
    starPromptBody:
      'Zano Office es gratuito y de código abierto. Una estrella en GitHub es la mejor forma de apoyar al equipo.',
    starPromptGo: 'Dar una estrella',
    starPromptDone: 'Ya la di',
    starPromptLater: 'Más tarde',
    onbStarHint: 'Si te gusta Zano Office, danos una estrella en GitHub.',
    ...
    // First-run onboarding
    onbTitle1: 'Bienvenido a Zano Office',
    ...
    onbBody2:
      'Zano Office aún está en alfa. Únete al chat grupal en Zano Office para compartir comentarios y ayudar a dar forma a lo que viene.',
    onbCredits: 'Los colaboradores activos reciben **1.000+ créditos de Genspark**',
    onbJoinCommunity: 'Unirse a Zano Office',
    onbSkip: 'Omitir',
    onbNext: 'Siguiente',
    onbStart: 'Empezar',
  ...
  th: {
    ...
    starPromptTitle: 'ชอบ Zano Office ไหม?',
    starPromptTitleN: 'คุณเปิดเอกสารด้วย Zano Office ไปแล้ว {n} ไฟล์',
    starPromptBody:
      'Zano Office ฟรีและเป็นโอเพนซอร์ส การกดดาวบน GitHub คือกำลังใจที่ดีที่สุดสำหรับทีม',
    starPromptGo: 'กดดาวเลย',
    starPromptDone: 'กดแล้ว',
    starPromptLater: 'ไว้ทีหลัง',
    onbStarHint: 'ถ้าชอบ Zano Office ฝากกดดาวให้เราบน GitHub ด้วยนะ',
    setEmail: 'อีเมล',
    ...
    newTab: 'แท็บใหม่',
    // First-run onboarding
    onbTitle1: 'ยินดีต้อนรับสู่ Zano Office',
    ...
    onbBody2:
      'Zano Office ยังอยู่ในช่วงอัลฟ่า เข้าร่วมแชทกลุ่มบน Zano Office เพื่อแบ่งปันความคิดเห็นและร่วมกำหนดทิศทางต่อไป',
    onbCredits: 'ผู้มีส่วนร่วมอย่างต่อเนื่องจะได้รับ **เครดิต Genspark กว่า 1,000**',
    onbJoinCommunity: 'เข้าร่วม Zano Office',
    onbSkip: 'ข้าม',
    onbNext: 'ถัดไป',
  ...
  id: {
    ...
    starPromptTitle: 'Suka Zano Office?',
    starPromptTitleN: 'Anda telah membuka {n} dokumen dengan Zano Office',
    starPromptBody:
      'Zano Office gratis dan open source. Bintang di GitHub adalah dukungan terbaik untuk tim kami.',
    starPromptGo: 'Beri Bintang',
    starPromptDone: 'Sudah',
    starPromptLater: 'Nanti saja',
    onbStarHint: 'Jika Anda menyukai Zano Office, beri kami bintang di GitHub.',
    setEmail: 'Email',
    ...
    newTab: 'Tab baru',
    // First-run onboarding
    onbTitle1: 'Selamat datang di Zano Office',
    ...
    onbBody2:
      'Zano Office masih dalam tahap alpha. Gabung obrolan grup di Zano Office untuk berbagi masukan dan ikut menentukan arah ke depan.',
    onbCredits: 'Kontributor aktif mendapat **1.000+ kredit Genspark**',
    onbJoinCommunity: 'Gabung Zano Office',
    onbSkip: 'Lewati',
    onbNext: 'Berikutnya',
    onbStart: 'Mulai',
  ...
  ru: {
    ...
    starPromptTitle: 'Нравится Zano Office?',
    starPromptTitleN: 'Вы уже открыли {n} документов в Zano Office',
    starPromptBody:
      'Zano Office — бесплатное ПО с открытым кодом. Звезда на GitHub — лучшая поддержка для команды.',
    starPromptGo: 'Поставить звезду',
    starPromptDone: 'Уже поставлена',
    starPromptLater: 'Позже',
    onbStarHint: 'Если вам нравится Zano Office, поставьте нам звезду на GitHub.',
    setEmail: 'Эл. почта',
    ...
    // First-run onboarding
    onbTitle1: 'Добро пожаловать в Zano Office',
    ...
    onbBody2:
      'Zano Office пока в альфа-версии. Присоединяйтесь к групповому чату в Zano Office, чтобы делиться отзывами и влиять на дальнейшее развитие.',
    onbCredits: 'Активные участники получают **1000+ кредитов Genspark**',
    onbJoinCommunity: 'Присоединиться к Zano Office',
    onbSkip: 'Пропустить',
    onbNext: 'Далее',
    onbStart: 'Начать',
  ...
  ar: {
    ...
    starPromptTitle: 'هل أعجبك Zano Office؟',
    starPromptTitleN: 'لقد فتحت {n} من المستندات في Zano Office',
    starPromptBody: 'Zano Office مجاني ومفتوح المصدر. نجمة على GitHub هي أفضل دعم للفريق.',
    starPromptGo: 'ضع نجمة',
    starPromptDone: 'وضعتها بالفعل',
    starPromptLater: 'لاحقًا',
    onbStarHint: 'إذا أعجبك Zano Office، ضع لنا نجمة على GitHub.',
    ...
    // First-run onboarding
    onbTitle1: 'مرحبًا بك في Zano Office',
    ...
    onbBody2:
      'لا يزال Zano Office في مرحلة ألفا. انضم إلى الدردشة الجماعية على Zano Office لمشاركة ملاحظاتك والمساهمة في تشكيل المستقبل.',
    onbCredits: 'يحصل المساهمون النشطون على **+1,000 من أرصدة Genspark**',
    onbJoinCommunity: 'الانضمام إلى Zano Office',
    onbSkip: 'تخطي',
    onbNext: 'التالي',
    onbStart: 'ابدأ الآن',
  ...
  pt: {
    ...
    starPromptTitle: 'Gostando do Zano Office?',
    starPromptTitleN: 'Você já abriu {n} documentos com o Zano Office',
    starPromptBody:
      'O Zano Office é gratuito e de código aberto. Uma estrela no GitHub é a melhor forma de apoiar a equipe.',
    starPromptGo: 'Dar uma estrela',
    starPromptDone: 'Já dei',
    starPromptLater: 'Mais tarde',
    onbStarHint: 'Se você gosta do Zano Office, deixe uma estrela no GitHub.',
    setEmail: 'E-mail',
    ...
    newTab: 'Nova guia',
    // First-run onboarding
    onbTitle1: 'Bem-vindo ao Zano Office',
    ...
    onbBody2:
      'O Zano Office ainda está em alfa. Entre no chat em grupo no Zano Office para compartilhar feedback e ajudar a moldar o que vem a seguir.',
    onbCredits: 'Contribuidores ativos recebem **1.000+ créditos Genspark**',
    onbJoinCommunity: 'Entrar no Zano Office',
    onbSkip: 'Pular',
    onbNext: 'Avançar',
    onbStart: 'Começar',
    onbStepAria: 'Página {n} de {total}',
  ...
  it: {
    ...
    starPromptTitle: 'Ti piace Zano Office?',
    starPromptTitleN: 'Hai aperto {n} documenti con Zano Office',
    starPromptBody:
      'Zano Office è gratuito e open source. Una stella su GitHub è il modo migliore per sostenere il team.',
    starPromptGo: 'Metti una stella',
    starPromptDone: 'Già fatto',
    starPromptLater: 'Più tardi',
    onbStarHint: 'Se ti piace Zano Office, lasciaci una stella su GitHub.',
    setEmail: 'Email',
    ...
    newTab: 'Nuova scheda',
    // First-run onboarding
    onbTitle1: 'Benvenuto in Zano Office',
    ...
    onbBody2:
      'Zano Office è ancora in alpha. Unisciti alla chat di gruppo su Zano Office per condividere feedback e contribuire a plasmare il futuro.',
    onbCredits: 'I collaboratori attivi ricevono **1.000+ crediti Genspark**',
    onbJoinCommunity: 'Unisciti a Zano Office',
    onbSkip: 'Salta',
    onbNext: 'Avanti',
    onbStart: 'Inizia',
  ...
  pl: {
    ...
    starPromptTitle: 'Podoba Ci się Zano Office?',
    starPromptTitleN: 'Otwarto już {n} dokumentów w Zano Office',
    starPromptBody:
      'Zano Office jest darmowy i open source. Gwiazdka na GitHubie to najlepsze wsparcie dla zespołu.',
    starPromptGo: 'Daj gwiazdkę',
    starPromptDone: 'Już zrobione',
    starPromptLater: 'Później',
    onbStarHint: 'Jeśli podoba Ci się Zano Office, zostaw nam gwiazdkę na GitHubie.',
    setEmail: 'E-mail',
    ...
    newTab: 'Nowa karta',
    // First-run onboarding
    onbTitle1: 'Witamy w Zano Office',
    ...
    onbBody2:
      'Zano Office jest wciąż w fazie alfa. Dołącz do czatu grupowego na Zano Office, aby dzielić się opiniami i współtworzyć jego przyszłość.',
    onbCredits: 'Aktywni współtwórcy otrzymują **1000+ kredytów Genspark**',
    onbJoinCommunity: 'Dołącz do Zano Office',
    onbSkip: 'Pomiń',
    onbNext: 'Dalej',
    onbStart: 'Rozpocznij',
  ...
  nl: {
    ...
    starPromptTitle: 'Bevalt Zano Office?',
    starPromptTitleN: 'Je hebt al {n} documenten geopend met Zano Office',
    starPromptBody:
      'Zano Office is gratis en open source. Een ster op GitHub is de beste steun voor het team.',
    starPromptGo: 'Geef een ster',
    starPromptDone: 'Al gedaan',
    starPromptLater: 'Later',
    onbStarHint: 'Als Zano Office je bevalt, geef ons dan een ster op GitHub.',
    setEmail: 'E-mail',
    ...
    // First-run onboarding
    onbTitle1: 'Welkom bij Zano Office',
    ...
    onbBody2:
      'Zano Office is nog in alfa. Doe mee aan de groepschat op Zano Office om feedback te delen en mee te bepalen wat er komt.',
    onbCredits: 'Actieve bijdragers krijgen **1.000+ Genspark-credits**',
    onbJoinCommunity: 'Word lid van Zano Office',
    onbSkip: 'Overslaan',
    onbNext: 'Volgende',
  ...
  ms: {
    ...
    starPromptTitleN: 'Anda telah membuka {n} dokumen dengan Zano Office',
    starPromptBody:
      'Zano Office percuma dan sumber terbuka. Bintang di GitHub ialah sokongan terbaik untuk pasukan kami.',
    starPromptGo: 'Beri Bintang',
    starPromptDone: 'Sudah',
    starPromptLater: 'Kemudian',
    onbStarHint: 'Jika anda suka Zano Office, beri kami bintang di GitHub.',
    setEmail: 'E-mel',
    ...
    newTab: 'Tab baharu',
    // First-run onboarding
    onbTitle1: 'Selamat datang ke Zano Office',
    ...
    onbTitle2: 'Ini baru permulaan',
    onbBody2:
      'Zano Office masih dalam peringkat alfa. Sertai sembang kumpulan di Zano Office untuk berkongsi maklum balas dan membentuk masa depannya.',
    onbCredits: 'Penyumbang aktif menerima **1,000+ kredit Genspark**',
    onbJoinCommunity: 'Sertai Zano Office',
    onbSkip: 'Langkau',
    onbNext: 'Seterusnya',
    onbStart: 'Mula',
  ...
  he: {
    ...
    starPromptTitle: 'נהנים מ-Zano Office?',
    starPromptTitleN: 'פתחת {n} מסמכים עם Zano Office',
    starPromptBody: 'Zano Office חינמי ובקוד פתוח. כוכב ב-GitHub הוא התמיכה הטובה ביותר בצוות.',
    starPromptGo: 'לתת כוכב',
    starPromptDone: 'כבר נתתי',
    starPromptLater: 'אחר כך',
    onbStarHint: 'אם Zano Office מוצא חן בעיניכם, תנו לנו כוכב ב-GitHub.',
    setEmail: 'אימייל',
    ...
    // First-run onboarding
    onbTitle1: 'ברוכים הבאים ל-Zano Office',
    ...
    onbBody2:
      'Zano Office עדיין בגרסת אלפא. הצטרפו לצ׳אט הקבוצתי ב-Zano Office כדי לשתף משוב ולעזור לעצב את ההמשך.',
    onbCredits: 'תורמים פעילים מקבלים **1,000+ נקודות Genspark**',
    onbJoinCommunity: 'הצטרפו ל-Zano Office',
    onbSkip: 'דילוג',
    onbNext: 'הבא',
    onbStart: 'להתחיל',
  ...
  hi: {
    ...
    starPromptTitle: 'Zano Office पसंद आ रहा है?',
    starPromptTitleN: 'आपने Zano Office में {n} दस्तावेज़ खोले हैं',
    starPromptBody:
      'Zano Office मुफ़्त और ओपन सोर्स है। GitHub पर एक स्टार टीम का सबसे अच्छा समर्थन है।',
    starPromptGo: 'स्टार दें',
    starPromptDone: 'पहले ही दे दिया',
    starPromptLater: 'बाद में',
    onbStarHint: 'अगर आपको Zano Office पसंद है, तो हमें GitHub पर स्टार दें।',
    setEmail: 'ईमेल',
    ...
    newTab: 'नया टैब',
    // First-run onboarding
    onbTitle1: 'Zano Office में आपका स्वागत है',
    ...
    onbBody2:
      'Zano Office अभी अल्फ़ा में है। Zano Office पर ग्रुप चैट से जुड़ें, फ़ीडबैक साझा करें और आगे की दिशा तय करने में मदद करें।',
    onbCredits: 'सक्रिय योगदानकर्ताओं के लिए **1,000+ Genspark क्रेडिट**',
    onbJoinCommunity: 'Zano Office से जुड़ें',
    onbSkip: 'छोड़ें',
    onbNext: 'आगे',
    onbStart: 'शुरू करें',
  ...
  'zh-TW': {
    ...
    starPromptTitle: '喜歡 Zano Office 嗎？',
    starPromptTitleN: '你已經用 Zano Office 開啟了 {n} 個文件',
    starPromptBody: 'Zano Office 是免費的開源軟體。到 GitHub 給我們一顆星，是對團隊最好的支持。',
    starPromptGo: '去給星星',
    starPromptDone: '已經給過了',
    starPromptLater: '以後再說',
    onbStarHint: '如果你喜歡 Zano Office，歡迎到 GitHub 給我們一顆星。',
    setEmail: '電子郵件',
    setNotLoggedIn: '未登入',
    setViewUsage: '查看用量',
    setChange: '變更',
    ...
    newTab: '新分頁',
    // First-run onboarding
    onbTitle1: '歡迎使用 Zano Office',
    onbSubtitle1: '第一個開源的 AI 原生 Office 套件',
    onbBody1: '建立文件、製作試算表、產生簡報、審閱 PDF。AI 深度融入每個環節。',
    onbTitle2: '這只是一個開始',
    onbBody2: 'Zano Office 目前仍在 alpha 階段。歡迎加入 Zano Office 群聊，分享回饋，一起打造它的未來。',
