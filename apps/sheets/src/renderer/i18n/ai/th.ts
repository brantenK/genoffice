...
export const th = {
  ...
  aiThinking: 'กำลังคิด…',
  aiWorkedSteps: 'ทำงานแล้ว · ใช้เครื่องมือ {n} ขั้นตอน',
  aiWorkedStepsWaiting: 'ใช้เครื่องมือแล้ว {n} ขั้นตอน · กำลังรอโมเดล',
  ...
  aiToolUpdateTaskPlan: 'อัปเดตรายการตรวจสอบงาน',
  ...
  aiRunRequesting: 'กำลังรอโมเดล',
  aiRunThinking: 'โมเดลกำลังคิด',
  aiRunResponding: 'โมเดลกำลังตอบกลับ',
  aiRunToolInput: 'โมเดลกำลังเตรียมอินพุตสำหรับเครื่องมือ',
  aiRunToolRunning: 'กำลังเรียกใช้เครื่องมือ',
  aiRunToolRunningNamed: 'กำลังเรียกใช้ {name}',
  aiRunApplying: 'กำลังนำการเปลี่ยนแปลงไปใช้กับเวิร์กบุ๊ก',
  aiRunVerifying: 'กำลังตรวจสอบผลลัพธ์ของสูตร',
  aiRunElapsed: 'รอบนี้ {seconds} วินาที',
  aiRunLastActivity: 'กิจกรรมล่าสุดเมื่อ {seconds} วินาทีที่แล้ว',
  aiRunWarningConnectionActive:
    'การเชื่อมต่อยังทำงานอยู่ แต่โมเดลไม่ได้สร้างเอาต์พุตมาระยะหนึ่งแล้ว',
  aiRunWarningNoActivity:
    'ไม่มีการทำงานจากผู้ให้บริการนานกว่า 30 วินาที โปรดตรวจสอบการเชื่อมต่อ หรือหยุดแล้วลองใหม่',
  aiTaskPlanAria: 'รายการตรวจสอบงาน',
  aiTaskPlanTitle: 'รายการตรวจสอบงาน',
  aiTaskPending: 'รอดำเนินการ',
  aiTaskInProgress: 'กำลังดำเนินการ',
  aiTaskCompleted: 'เสร็จสมบูรณ์',
  aiTruncated:
    'การตอบกลับหยุดลงเมื่อถึงขีดจำกัดเอาต์พุตของโมเดล ส่ง “ดำเนินการต่อ” เพื่อทำงานที่เหลือให้เสร็จ',
