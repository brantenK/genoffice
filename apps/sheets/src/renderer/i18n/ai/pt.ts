...
export const pt = {
  ...
  aiThinking: 'Pensando…',
  aiWorkedSteps: 'Trabalho realizado · {n} etapas com ferramentas',
  aiWorkedStepsWaiting: '{n} etapas com ferramentas concluídas · aguardando o modelo',
  ...
  aiToolUpdateTaskPlan: 'Atualizar lista de tarefas',
  ...
  aiRunRequesting: 'Aguardando o modelo',
  aiRunThinking: 'O modelo está pensando',
  aiRunResponding: 'O modelo está respondendo',
  aiRunToolInput: 'O modelo está preparando a entrada da ferramenta',
  aiRunToolRunning: 'Executando ferramenta',
  aiRunToolRunningNamed: 'Executando {name}',
  aiRunApplying: 'Aplicando alterações à pasta de trabalho',
  aiRunVerifying: 'Verificando resultados das fórmulas',
  aiRunElapsed: 'Turno: {seconds} s',
  aiRunLastActivity: 'Última atividade há {seconds} s',
  aiRunWarningConnectionActive:
    'A conexão está ativa, mas o modelo não gerou nenhuma saída recentemente.',
  aiRunWarningNoActivity:
    'Sem atividade do provedor há mais de 30 segundos. Verifique sua conexão ou pare e tente novamente.',
  aiTaskPlanAria: 'Lista de tarefas',
  aiTaskPlanTitle: 'Lista de tarefas',
  aiTaskPending: 'Pendente',
  aiTaskInProgress: 'Em andamento',
  aiTaskCompleted: 'Concluída',
  aiTruncated:
    'A resposta parou no limite de saída do modelo. Envie “continuar” para concluir o trabalho restante.',
