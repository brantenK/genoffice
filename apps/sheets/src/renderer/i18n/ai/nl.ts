...
export const nl = {
  ...
  aiWorkedSteps: 'Uitgevoerd · {n} toolstappen',
  aiWorkedStepsWaiting: '{n} toolstappen uitgevoerd · wachten op het model',
  ...
  aiToolUpdateTaskPlan: 'Takenlijst bijwerken',
  ...
  aiRunRequesting: 'Wachten op het model',
  aiRunThinking: 'Het model denkt na',
  aiRunResponding: 'Het model reageert',
  aiRunToolInput: 'Het model bereidt toolinvoer voor',
  aiRunToolRunning: 'Tool uitvoeren',
  aiRunToolRunningNamed: '{name} uitvoeren',
  aiRunApplying: 'Wijzigingen in de werkmap toepassen',
  aiRunVerifying: 'Formuleresultaten controleren',
  aiRunElapsed: 'Beurt: {seconds} s',
  aiRunLastActivity: 'Laatste activiteit {seconds} s geleden',
  aiRunWarningConnectionActive:
    'De verbinding is actief, maar het model heeft onlangs geen uitvoer geproduceerd.',
  aiRunWarningNoActivity:
    'Al meer dan 30 seconden geen activiteit van de provider. Controleer je verbinding of stop en probeer het opnieuw.',
  aiTaskPlanAria: 'Takenlijst',
  aiTaskPlanTitle: 'Takenlijst',
  aiTaskPending: 'In afwachting',
  aiTaskInProgress: 'Bezig',
  aiTaskCompleted: 'Voltooid',
  aiTruncated:
    'Het antwoord stopte bij de uitvoerlimiet van het model. Stuur ‘doorgaan’ om het resterende werk af te ronden.',
