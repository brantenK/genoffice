...
export const zh = {
  ...
  aiThinkingAria: '思考中',
  aiThinking: '思考中…',
  aiWorkedSteps: '已完成 · {n} 个工具步骤',
  aiWorkedStepsWaiting: '已执行 {n} 个工具步骤 · 正在等待模型',
  aiGroupWorking: '处理中…',
  aiWorking: '执行中…',
  ...
  aiRunRequesting: '正在等待模型响应',
  aiRunThinking: '模型正在思考',
  aiRunResponding: '模型正在回复',
  aiRunToolInput: '模型正在准备工具参数',
  aiRunToolRunning: '正在执行工具',
  aiRunToolRunningNamed: '正在执行 {name}',
  aiRunApplying: '正在应用工作簿更改',
  aiRunVerifying: '正在核对公式结果',
  aiRunElapsed: '本轮 {seconds} 秒',
  aiRunLastActivity: '上次活动在 {seconds} 秒前',
  aiRunWarningConnectionActive: '连接仍活跃，但模型暂时没有产生内容。',
  aiRunWarningNoActivity: '超过 30 秒未收到服务活动，请检查网络；你也可以停止后重试。',
  aiTaskPlanAria: '任务清单',
  aiTaskPlanTitle: '任务清单',
  aiTaskPending: '待处理',
  aiTaskInProgress: '进行中',
  aiTaskCompleted: '已完成',
  aiTruncated: '回复因达到模型输出上限而中断。请发送“继续”以完成剩余内容。',
}
