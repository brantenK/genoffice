...
export const he = {
  ...
  aiThinkingAria: 'חושב',
  aiThinking: 'חושב…',
  aiWorkedSteps: 'בוצעו · {n} שלבי כלי',
  aiWorkedStepsWaiting: 'בוצעו {n} שלבי כלי · בהמתנה למודל',
  ...
  aiToolUpdateTaskPlan: 'עדכון רשימת המשימות',
  ...
  aiRunRequesting: 'ממתין למודל',
  aiRunThinking: 'המודל חושב',
  aiRunResponding: 'המודל מגיב',
  aiRunToolInput: 'המודל מכין קלט לכלי',
  aiRunToolRunning: 'מפעיל כלי',
  aiRunToolRunningNamed: 'מפעיל את {name}',
  aiRunApplying: 'מחיל שינויים על חוברת העבודה',
  aiRunVerifying: 'בודק תוצאות נוסחאות',
  aiRunElapsed: 'סבב {seconds} שנ׳',
  aiRunLastActivity: 'פעילות אחרונה לפני {seconds} שנ׳',
  aiRunWarningConnectionActive:
    'החיבור פעיל, אך המודל לא הפיק פלט לאחרונה.',
  aiRunWarningNoActivity:
    'אין פעילות מהספק כבר יותר מ-30 שניות. בדוק את החיבור, או עצור ונסה שוב.',
  aiTaskPlanAria: 'רשימת משימות',
  aiTaskPlanTitle: 'רשימת משימות',
  aiTaskPending: 'ממתין',
  aiTaskInProgress: 'בטיפול',
  aiTaskCompleted: 'הושלם',
  aiTruncated:
    'התגובה נעצרה במגבלת הפלט של המודל. שלח ״המשך״ כדי להשלים את העבודה שנותרה.',
