...
export const ar = {
  ...
  aiThinking: 'يفكّر…',
  aiWorkedSteps: 'تم التنفيذ · {n} خطوات بالأدوات',
  aiWorkedStepsWaiting: 'تم تنفيذ {n} خطوات بالأدوات · في انتظار النموذج',
  ...
  aiToolUpdateTaskPlan: 'تحديث قائمة مهام العمل',
  ...
  aiRunRequesting: 'في انتظار النموذج',
  aiRunThinking: 'النموذج يفكّر',
  aiRunResponding: 'النموذج يستجيب',
  aiRunToolInput: 'النموذج يُعِدّ مدخلات الأداة',
  aiRunToolRunning: 'جارٍ تشغيل الأداة',
  aiRunToolRunningNamed: 'جارٍ تشغيل {name}',
  aiRunApplying: 'جارٍ تطبيق تغييرات المصنف',
  aiRunVerifying: 'جارٍ التحقق من نتائج الصيغ',
  aiRunElapsed: 'الجولة {seconds} ث',
  aiRunLastActivity: 'آخر نشاط منذ {seconds} ث',
  aiRunWarningConnectionActive:
    'الاتصال نشط، لكن النموذج لم يُنتج مخرجات مؤخرًا.',
  aiRunWarningNoActivity:
    'لا يوجد نشاط من موفّر الخدمة منذ أكثر من 30 ثانية. تحقق من اتصالك، أو أوقف العملية وأعد المحاولة.',
  aiTaskPlanAria: 'قائمة مهام العمل',
  aiTaskPlanTitle: 'قائمة مهام العمل',
  aiTaskPending: 'قيد الانتظار',
  aiTaskInProgress: 'قيد التنفيذ',
  aiTaskCompleted: 'مكتمل',
  aiTruncated:
    'توقفت الاستجابة عند حد مخرجات النموذج. أرسل «متابعة» لإكمال العمل المتبقي.',
