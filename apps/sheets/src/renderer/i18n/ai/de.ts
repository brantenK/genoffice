...
export const de = {
  ...
  aiPhaseInspect: 'Arbeitsmappe wird geprüft…',
  aiPhaseRead: 'Zellen werden gelesen…',
  aiPhaseWrite: 'Zellen werden geschrieben…',
  aiPhaseVerify: 'Ergebnisse werden überprüft…',
  aiPhaseDone: 'Erledigt',
