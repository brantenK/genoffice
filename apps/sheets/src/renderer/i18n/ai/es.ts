...
export const es = {
  ...
  aiPhaseInspect: 'Inspeccionando el libro…',
  aiPhaseRead: 'Leyendo celdas…',
  aiPhaseWrite: 'Escribiendo celdas…',
  aiPhaseVerify: 'Comprobando resultados…',
  aiPhaseDone: 'Completado',
