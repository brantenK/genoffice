...
export const ko = {
  ...
  aiThinkingAria: '생각 중',
  aiThinking: '생각 중…',
  aiWorkedSteps: '처리됨 · 도구 {n}단계',
  aiWorkedStepsWaiting: '도구 {n}단계 처리 · 모델 대기 중',
  aiGroupWorking: '작업 중…',
  aiWorking: '실행 중…',
  ...
  aiToolUpdateTaskPlan: '작업 체크리스트 업데이트',
  ...
  aiRunRequesting: '모델 대기 중',
  aiRunThinking: '모델이 생각 중',
  aiRunResponding: '모델이 응답 중',
  aiRunToolInput: '모델이 도구 입력 준비 중',
  aiRunToolRunning: '도구 실행 중',
  aiRunToolRunningNamed: '{name} 실행 중',
  aiRunApplying: '통합 문서 변경 적용 중',
  aiRunVerifying: '수식 결과 확인 중',
  aiRunElapsed: '턴 {seconds}초',
  aiRunLastActivity: '마지막 활동: {seconds}초 전',
  aiRunWarningConnectionActive:
    '연결은 활성 상태이지만 모델이 최근 출력을 생성하지 않았습니다.',
  aiRunWarningNoActivity:
    '30초 넘게 공급자 활동이 없습니다. 연결을 확인하거나 중지한 후 다시 시도하세요.',
  aiTaskPlanAria: '작업 체크리스트',
  aiTaskPlanTitle: '작업 체크리스트',
  aiTaskPending: '대기 중',
  aiTaskInProgress: '진행 중',
  aiTaskCompleted: '완료',
  aiTruncated:
    '모델 출력 한도에 도달해 응답이 중단되었습니다. 남은 작업을 완료하려면 “계속”을 보내세요.',
