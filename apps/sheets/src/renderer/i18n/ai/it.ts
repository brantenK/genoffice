...
export const it = {
  ...
  aiPhaseInspect: 'Ispezione della cartella di lavoro…',
  aiPhaseRead: 'Lettura delle celle…',
  aiPhaseWrite: 'Scrittura delle celle…',
  aiPhaseVerify: 'Verifica dei risultati…',
  aiPhaseDone: 'Completato',
