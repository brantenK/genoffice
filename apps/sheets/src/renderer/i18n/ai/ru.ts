...
export const ru = {
  ...
  aiThinking: 'Думает…',
  aiWorkedSteps: 'Выполнено · {n} шагов с инструментами',
  aiWorkedStepsWaiting: 'Выполнено шагов с инструментами: {n} · ожидание модели',
  ...
  aiToolUpdateTaskPlan: 'Обновление списка задач',
  ...
  aiRunRequesting: 'Ожидание модели',
  aiRunThinking: 'Модель думает',
  aiRunResponding: 'Модель отвечает',
  aiRunToolInput: 'Модель готовит входные данные для инструмента',
  aiRunToolRunning: 'Запуск инструмента',
  aiRunToolRunningNamed: 'Запуск {name}',
  aiRunApplying: 'Применение изменений к книге',
  aiRunVerifying: 'Проверка результатов формул',
  aiRunElapsed: 'Ход: {seconds} с',
  aiRunLastActivity: 'Последняя активность {seconds} с назад',
  aiRunWarningConnectionActive:
    'Подключение активно, но модель в последнее время не выдавала результатов.',
  aiRunWarningNoActivity:
    'Поставщик не проявляет активности более 30 секунд. Проверьте подключение либо остановите и повторите попытку.',
  aiTaskPlanAria: 'Список задач',
  aiTaskPlanTitle: 'Список задач',
  aiTaskPending: 'Ожидает',
  aiTaskInProgress: 'Выполняется',
  aiTaskCompleted: 'Завершено',
  aiTruncated:
    'Ответ остановился на пределе вывода модели. Отправьте «продолжить», чтобы завершить оставшуюся работу.',
