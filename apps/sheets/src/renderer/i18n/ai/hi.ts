...
export const hi = {
  ...
  aiWorkedSteps: 'कार्य किया · टूल के {n} चरण',
  aiWorkedStepsWaiting: 'टूल के {n} चरण पूरे · मॉडल की प्रतीक्षा',
  ...
  aiToolUpdateTaskPlan: 'कार्य सूची अपडेट करें',
  ...
  aiRunRequesting: 'मॉडल की प्रतीक्षा',
  aiRunThinking: 'मॉडल सोच रहा है',
  aiRunResponding: 'मॉडल जवाब दे रहा है',
  aiRunToolInput: 'मॉडल टूल इनपुट तैयार कर रहा है',
  aiRunToolRunning: 'टूल चल रहा है',
  aiRunToolRunningNamed: '{name} चल रहा है',
  aiRunApplying: 'वर्कबुक में बदलाव लागू हो रहे हैं',
  aiRunVerifying: 'सूत्र परिणामों की जाँच हो रही है',
  aiRunElapsed: 'टर्न {seconds} सेकंड',
  aiRunLastActivity: 'अंतिम गतिविधि {seconds} सेकंड पहले',
  aiRunWarningConnectionActive:
    'कनेक्शन सक्रिय है, लेकिन मॉडल ने हाल में कोई आउटपुट नहीं दिया है।',
  aiRunWarningNoActivity:
    'प्रदाता की ओर से 30 सेकंड से अधिक समय से कोई गतिविधि नहीं हुई। कनेक्शन जाँचें या रोककर फिर से प्रयास करें।',
  aiTaskPlanAria: 'कार्य सूची',
  aiTaskPlanTitle: 'कार्य सूची',
  aiTaskPending: 'लंबित',
  aiTaskInProgress: 'प्रगति पर',
  aiTaskCompleted: 'पूर्ण',
  aiTruncated:
    'मॉडल की आउटपुट सीमा पर प्रतिक्रिया रुक गई। बाकी काम पूरा करने के लिए “जारी रखें” भेजें।',
