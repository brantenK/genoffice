/**
 * ExampleOffice Slides main process — pptx parsing/render-tree building/edit application/saving all live
...
/**
 * Recovery drafts for never-saved decks (wcId → visible path in <Documents>/ExampleOffice):
...
/** Directory where AI-generated drafts are saved: the configurable default save folder (falls back to <Documents>/ExampleOffice) */
...
/**
 * Auto-save the draft to <Documents>/ExampleOffice/<name>.pptx after AI generation completes.
