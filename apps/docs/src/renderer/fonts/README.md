...
The serif subset also backs the `Zanostack Fullwidth TC` face (`fonts.css`), a
...
| Font                                 | Role                                                        |
| ------------------------------------ | ----------------------------------------------------------- |
| Zanostack Serif KR (subset woff2)    | Batang-metric stand-in for Korean serif families            |
| Zanostack Sans KR (subset woff2)     | fallback for Korean sans families (Malgun etc.)             |
| Zanostack Che Latin KR (ASCII woff2) | half-width Latin for BatangChe/GulimChe/DotumChe/GungsuhChe |
...
`GenOfficeCheLatinKR.woff2` is an ASCII-only derivative of Zanostack Sans KR.
...
| Font                               | Role                                            |
| ---------------------------------- | ----------------------------------------------- |
| Zanostack Gothic KR (subset woff2) | real-metric face for NanumGothic-declaring docs |
...
### Zanostack UI Kana JP

| Font                                      | Role                                                |
| ----------------------------------------- | --------------------------------------------------- |
| Zanostack UI Kana JP (Regular/Bold woff2) | Meiryo UI-advance kana/JP punctuation for the alias |
...
| Font                             | Role                                 |
| -------------------------------- | ------------------------------------ |
| Zanostack Poppins (subset woff2) | real face for Poppins-declaring docs |
...
| Font                    | Role                                     |
| ----------------------- | ---------------------------------------- |
| Zanostack Tamil (woff2) | Latha-metric stand-in for Tamil families |
...
| Font                              | Role                                             |
| --------------------------------- | ------------------------------------------------ |
| Zanostack PUA Blank (woff2, 312B) | blank 1em glyph for all of U+E000-F8FF (BMP PUA) |
